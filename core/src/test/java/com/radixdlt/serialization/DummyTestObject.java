...
public final class DummyTestObject extends BasicContainer {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(btrue, bfalse, num, id, theHash, string, array, object) * 31
  ...
  public String toString() {
    return String.format(
        "%s[btrue=%s, bfalse=%s, num=%s, id=%s, theHash=%s, bytes=%s, string=%s, array=%s,"
            + " object=%s]",
