...
public class DurationParserTest {
  ...
  public void correctDurationsAreParsedProperly() {
    assertEquals(
        ...
        DurationParser.parse("123").orElseThrow(AssertionError::new));
    assertEquals(
        Duration.of(321, ChronoUnit.SECONDS),
        DurationParser.parse("321s").orElseThrow(AssertionError::new));
    assertEquals(
        Duration.of(213, ChronoUnit.MINUTES),
        DurationParser.parse("213m").orElseThrow(AssertionError::new));
    assertEquals(
        Duration.of(132, ChronoUnit.HOURS),
        DurationParser.parse("132h").orElseThrow(AssertionError::new));
  }
  ...
  public void fractionalValuesAreTruncated() {
    assertEquals(
        Duration.of(123, ChronoUnit.SECONDS),
        DurationParser.parse("123.9").orElseThrow(AssertionError::new));
  }
