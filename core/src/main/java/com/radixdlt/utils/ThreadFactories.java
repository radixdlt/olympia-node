...
public final class ThreadFactories {
  ...
  /**
   * Creates a {@link ThreadFactory} that uses the specified format string to create threads with
   * identifiable names. The threads created by the factory will be daemon threads.
   *
   * @param nameFormat a {@link String#format(String, Object...)}-compatible format {@link String},
   *     to which a unique integer (0, 1, etc.) will be supplied as the single parameter. This
   *     integer will be unique and assigned sequentially as each thread is constructed. For
  ...
  /**
   * Creates a {@link ThreadFactory} that uses the specified format string to create threads with
   * identifiable names. The threads created by the factory will be non-daemon threads.
   *
   * @param nameFormat a {@link String#format(String, Object...)}-compatible format {@link String},
   *     to which a unique integer (0, 1, etc.) will be supplied as the single parameter. This
   *     integer will be unique and assigned sequentially as each thread is constructed. For
