 ...
 */
@JsonPropertyOrder({
  PartialStateIdentifier.JSON_PROPERTY_STATE_VERSION,
  PartialStateIdentifier.JSON_PROPERTY_TRANSACTION_ACCUMULATOR
})
...
public class PartialStateIdentifier {
  ...
  public static final String JSON_PROPERTY_TRANSACTION_ACCUMULATOR = "transaction_accumulator";
  ...
  **/
  ...
  @ApiModelProperty(value = "Accumulator hash representing all transactions which occurred up to `state_version`. Hex encoded.")
  @JsonProperty(JSON_PROPERTY_TRANSACTION_ACCUMULATOR)
  ...
  /**
   * Return true if this PartialStateIdentifier object is equal to o.
   */
  @Override
