...
public class ConstructionDeriveRequestMetadataValidator extends ConstructionDeriveRequestMetadata {

  /**
   * Return true if this ConstructionDeriveRequestMetadataValidator object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ConstructionDeriveRequestMetadataValidator {\n");
...
static {
  ...
  JSON.registerDiscriminator(ConstructionDeriveRequestMetadataValidator.class, "type", mappings);
}
}
