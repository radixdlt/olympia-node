 ...
 */
@JsonPropertyOrder({
  SubEntityMetadata.JSON_PROPERTY_VALIDATOR_ADDRESS,
  SubEntityMetadata.JSON_PROPERTY_EPOCH_UNLOCK
})
...
public class SubEntityMetadata {
  ...
  **/
  ...
  /**
   * Return true if this SubEntityMetadata object is equal to o.
   */
  @Override
