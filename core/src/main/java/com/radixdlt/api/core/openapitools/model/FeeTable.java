 ...
 */
@JsonPropertyOrder({
  FeeTable.JSON_PROPERTY_PER_UP_SUBSTATE_FEE,
  FeeTable.JSON_PROPERTY_PER_BYTE_FEE
})
...
public class FeeTable {
  public static final String JSON_PROPERTY_PER_UP_SUBSTATE_FEE = "per_up_substate_fee";
  private List<UpSubstateFeeEntry> perUpSubstateFee = new ArrayList<>();

  public static final String JSON_PROPERTY_PER_BYTE_FEE = "per_byte_fee";
  private ResourceAmount perByteFee;


  public FeeTable perUpSubstateFee(List<UpSubstateFeeEntry> perUpSubstateFee) {
    this.perUpSubstateFee = perUpSubstateFee;
    return this;
  }

  public FeeTable addPerUpSubstateFeeItem(UpSubstateFeeEntry perUpSubstateFeeItem) {
    this.perUpSubstateFee.add(perUpSubstateFeeItem);
    return this;
  }

   /**
   * Get perUpSubstateFee
   * @return perUpSubstateFee
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_PER_UP_SUBSTATE_FEE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<UpSubstateFeeEntry> getPerUpSubstateFee() {
    return perUpSubstateFee;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PER_UP_SUBSTATE_FEE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPerUpSubstateFee(List<UpSubstateFeeEntry> perUpSubstateFee) {
    this.perUpSubstateFee = perUpSubstateFee;
  }


  public FeeTable perByteFee(ResourceAmount perByteFee) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_PER_BYTE_FEE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public ResourceAmount getPerByteFee() {
    return perByteFee;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PER_BYTE_FEE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPerByteFee(ResourceAmount perByteFee) {
    this.perByteFee = perByteFee;
  }


  /**
   * Return true if this FeeTable object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FeeTable feeTable = (FeeTable) o;
    return Objects.equals(this.perUpSubstateFee, feeTable.perUpSubstateFee) &&
        Objects.equals(this.perByteFee, feeTable.perByteFee);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeeTable {\n");
    sb.append("    perUpSubstateFee: ").append(toIndentedString(perUpSubstateFee)).append("\n");
    sb.append("    perByteFee: ").append(toIndentedString(perByteFee)).append("\n");
    sb.append("}");
    return sb.toString();
  }
