 ...
 */
@JsonPropertyOrder({
  TokenMetadata.JSON_PROPERTY_SYMBOL,
  TokenMetadata.JSON_PROPERTY_NAME,
  TokenMetadata.JSON_PROPERTY_DESCRIPTION,
  TokenMetadata.JSON_PROPERTY_URL,
  TokenMetadata.JSON_PROPERTY_ICON_URL
})
...
public class TokenMetadata extends DataObject {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The symbol of the token (not unique in the system).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Description describing the token.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A url which points to more information about the token.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A url which points to the icon of the token.")
...
static {
  ...
  mappings.put("TokenMetadata", TokenMetadata.class);
  JSON.registerDiscriminator(TokenMetadata.class, "type", mappings);
}
}
