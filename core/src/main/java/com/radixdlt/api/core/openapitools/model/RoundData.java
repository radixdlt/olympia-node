 ...
 */
@JsonPropertyOrder({
  RoundData.JSON_PROPERTY_ROUND,
  RoundData.JSON_PROPERTY_TIMESTAMP
})
...
public class RoundData extends DataObject {
  ...
  **/
  ...
  /**
   * Return true if this RoundData object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("RoundData", RoundData.class);
  JSON.registerDiscriminator(RoundData.class, "type", mappings);
}
}
