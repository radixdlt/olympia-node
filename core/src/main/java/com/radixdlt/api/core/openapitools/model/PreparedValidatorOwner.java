 ...
 */
@JsonPropertyOrder({
  PreparedValidatorOwner.JSON_PROPERTY_OWNER,
  PreparedValidatorOwner.JSON_PROPERTY_EPOCH
})
...
public class PreparedValidatorOwner extends DataObject {
  ...
  **/
  ...
  /**
   * Return true if this PreparedValidatorOwner object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("PreparedValidatorOwner", PreparedValidatorOwner.class);
  JSON.registerDiscriminator(PreparedValidatorOwner.class, "type", mappings);
}
}
