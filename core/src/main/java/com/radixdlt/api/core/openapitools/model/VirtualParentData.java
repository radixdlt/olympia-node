 ...
 */
@JsonPropertyOrder({
  VirtualParentData.JSON_PROPERTY_ENTITY_SET_IDENTIFIER,
  VirtualParentData.JSON_PROPERTY_VIRTUAL_DATA_OBJECT
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-29T12:30:03.997620-06:00[America/Chicago]")
...
public class VirtualParentData extends DataObject {
  ...
  public static final String JSON_PROPERTY_VIRTUAL_DATA_OBJECT = "virtual_data_object";
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_VIRTUAL_DATA_OBJECT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this VirtualParentData object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("VirtualParentData", VirtualParentData.class);
  JSON.registerDiscriminator(VirtualParentData.class, "type", mappings);
}
}
