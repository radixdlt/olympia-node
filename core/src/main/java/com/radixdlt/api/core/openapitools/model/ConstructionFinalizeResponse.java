 ...
 */
@JsonPropertyOrder({
  ConstructionFinalizeResponse.JSON_PROPERTY_SIGNED_TRANSACTION
})
...
public class ConstructionFinalizeResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Hex encoded signed transaction which can be submitted.")
  ...
  /**
   * Return true if this ConstructionFinalizeResponse object is equal to o.
   */
  @Override
