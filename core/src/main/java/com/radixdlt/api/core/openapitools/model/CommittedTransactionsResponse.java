 ...
 */
@ApiModel(description = "A response of committed transactions which specifies the state updates which have occurred on ledger.")
@JsonPropertyOrder({
  CommittedTransactionsResponse.JSON_PROPERTY_STATE_IDENTIFIER,
...
public class CommittedTransactionsResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A committed transactions list starting from the `state_identifier`.")
