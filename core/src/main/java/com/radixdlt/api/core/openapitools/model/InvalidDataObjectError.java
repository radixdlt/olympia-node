 ...
 */
@JsonPropertyOrder({
  InvalidDataObjectError.JSON_PROPERTY_INVALID_DATA_OBJECT,
  InvalidDataObjectError.JSON_PROPERTY_MESSAGE
})
...
public class InvalidDataObjectError extends CoreError {
  ...
  public InvalidDataObjectError invalidDataObject(DataObject invalidDataObject) {
  ...
  **/
  ...
  public InvalidDataObjectError message(String message) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidDataObjectError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidDataObjectError invalidDataObjectError = (InvalidDataObjectError) o;
    return Objects.equals(this.invalidDataObject, invalidDataObjectError.invalidDataObject) &&
        Objects.equals(this.message, invalidDataObjectError.message) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidDataObjectError {\n");
...
static {
  ...
  mappings.put("InvalidDataObjectError", InvalidDataObjectError.class);
  JSON.registerDiscriminator(InvalidDataObjectError.class, "type", mappings);
}
}
