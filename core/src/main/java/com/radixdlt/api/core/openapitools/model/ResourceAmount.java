 ...
 */
@JsonPropertyOrder({
  ResourceAmount.JSON_PROPERTY_VALUE,
  ResourceAmount.JSON_PROPERTY_RESOURCE_IDENTIFIER
})
...
public class ResourceAmount {
  ...
  public static final String JSON_PROPERTY_RESOURCE_IDENTIFIER = "resource_identifier";
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_RESOURCE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
