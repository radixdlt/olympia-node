 ...
 */
@JsonPropertyOrder({
  StateIdentifier.JSON_PROPERTY_STATE_VERSION,
  StateIdentifier.JSON_PROPERTY_TRANSACTION_ACCUMULATOR
})
...
public class StateIdentifier {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Accumulator hash representing all transactions which occurred up to `state_version`. Hex encoded.")
  ...
  /**
   * Return true if this StateIdentifier object is equal to o.
   */
  @Override
