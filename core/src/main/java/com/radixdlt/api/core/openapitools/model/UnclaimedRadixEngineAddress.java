...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-30T18:31:03.818538-06:00[America/Chicago]")
...
public class UnclaimedRadixEngineAddress extends DataObject {
  ...
  /**
   * Return true if this UnclaimedRadixEngineAddress object is equal to o.
   */
  @Override
  ...
  static {
    ...
    mappings.put("UnclaimedRadixEngineAddress", UnclaimedRadixEngineAddress.class);
    JSON.registerDiscriminator(UnclaimedRadixEngineAddress.class, "type", mappings);
  }
}
