 ...
 */
@ApiModel(description = "Hex encoded unique identifier for the substate.")
@JsonPropertyOrder({
  SubstateIdentifier.JSON_PROPERTY_IDENTIFIER
})
...
public class SubstateIdentifier {
  ...
  **/
  ...
  /**
   * Return true if this SubstateIdentifier object is equal to o.
   */
  @Override
