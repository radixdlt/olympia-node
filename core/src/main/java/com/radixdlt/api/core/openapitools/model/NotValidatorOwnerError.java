...
public class NotValidatorOwnerError extends CoreError {
  ...
  public NotValidatorOwnerError owner(EntityIdentifier owner) {
    this.owner = owner;
    return this;
  }
  ...
  **/
  ...
  public NotValidatorOwnerError user(EntityIdentifier user) {
    this.user = user;
    return this;
  }
