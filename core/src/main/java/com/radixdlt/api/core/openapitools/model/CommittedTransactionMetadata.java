 ...
 */
@JsonPropertyOrder({
  CommittedTransactionMetadata.JSON_PROPERTY_SIZE,
  CommittedTransactionMetadata.JSON_PROPERTY_HEX,
  CommittedTransactionMetadata.JSON_PROPERTY_FEE,
  CommittedTransactionMetadata.JSON_PROPERTY_SIGNED_BY,
  CommittedTransactionMetadata.JSON_PROPERTY_MESSAGE
})
...
public class CommittedTransactionMetadata {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The size of the transaction in bytes.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The raw transaction bytes in hex encoding.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Optional hex encoded byte array in the transaction.")
  ...
  /**
   * Return true if this CommittedTransactionMetadata object is equal to o.
   */
  @Override
