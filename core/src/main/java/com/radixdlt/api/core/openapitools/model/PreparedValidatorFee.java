 ...
 */
@JsonPropertyOrder({
  PreparedValidatorFee.JSON_PROPERTY_FEE,
  PreparedValidatorFee.JSON_PROPERTY_EPOCH
})
...
public class PreparedValidatorFee extends DataObject {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The fee percentage of the validator which will be updated in the future epoch.")
  ...
  **/
  ...
  /**
   * Return true if this PreparedValidatorFee object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("PreparedValidatorFee", PreparedValidatorFee.class);
  JSON.registerDiscriminator(PreparedValidatorFee.class, "type", mappings);
}
}
