 ...
 */
@JsonPropertyOrder({
  StateIdentifierNotFoundError.JSON_PROPERTY_STATE_IDENTIFIER
})
...
public class StateIdentifierNotFoundError extends CoreError {
  public static final String JSON_PROPERTY_STATE_IDENTIFIER = "state_identifier";
  private PartialStateIdentifier stateIdentifier;


  public StateIdentifierNotFoundError stateIdentifier(PartialStateIdentifier stateIdentifier) {
  ...
  **/
  ...
  /**
   * Return true if this StateIdentifierNotFoundError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StateIdentifierNotFoundError stateIdentifierNotFoundError = (StateIdentifierNotFoundError) o;
    return Objects.equals(this.stateIdentifier, stateIdentifierNotFoundError.stateIdentifier) &&
        super.equals(o);
  }
...
static {
  ...
  mappings.put("StateIdentifierNotFoundError", StateIdentifierNotFoundError.class);
  JSON.registerDiscriminator(StateIdentifierNotFoundError.class, "type", mappings);
}
}
