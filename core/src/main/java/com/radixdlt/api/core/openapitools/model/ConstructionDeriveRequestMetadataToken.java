 ...
 */
@JsonPropertyOrder({
  ConstructionDeriveRequestMetadataToken.JSON_PROPERTY_SYMBOL
})
...
public class ConstructionDeriveRequestMetadataToken extends ConstructionDeriveRequestMetadata {
  public static final String JSON_PROPERTY_SYMBOL = "symbol";
  private String symbol;


  public ConstructionDeriveRequestMetadataToken symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The symbol of the token")
  ...
  /**
   * Return true if this ConstructionDeriveRequestMetadataToken object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ConstructionDeriveRequestMetadataToken constructionDeriveRequestMetadataToken = (ConstructionDeriveRequestMetadataToken) o;
    return Objects.equals(this.symbol, constructionDeriveRequestMetadataToken.symbol) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConstructionDeriveRequestMetadataToken {\n");
...
static {
  ...
  JSON.registerDiscriminator(ConstructionDeriveRequestMetadataToken.class, "type", mappings);
}
}
