 ...
 */
@JsonPropertyOrder({
  UpSubstateFeeEntry.JSON_PROPERTY_SUBSTATE_TYPE_IDENTIFIER,
  UpSubstateFeeEntry.JSON_PROPERTY_FEE
})
...
public class UpSubstateFeeEntry {
  public static final String JSON_PROPERTY_SUBSTATE_TYPE_IDENTIFIER = "substate_type_identifier";
  private SubstateTypeIdentifier substateTypeIdentifier;

  public static final String JSON_PROPERTY_FEE = "fee";
  private ResourceAmount fee;


  public UpSubstateFeeEntry substateTypeIdentifier(SubstateTypeIdentifier substateTypeIdentifier) {
    this.substateTypeIdentifier = substateTypeIdentifier;
    return this;
  }

   /**
   * Get substateTypeIdentifier
   * @return substateTypeIdentifier
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_SUBSTATE_TYPE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public SubstateTypeIdentifier getSubstateTypeIdentifier() {
    return substateTypeIdentifier;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUBSTATE_TYPE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSubstateTypeIdentifier(SubstateTypeIdentifier substateTypeIdentifier) {
    this.substateTypeIdentifier = substateTypeIdentifier;
  }


  public UpSubstateFeeEntry fee(ResourceAmount fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this UpSubstateFeeEntry object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpSubstateFeeEntry upSubstateFeeEntry = (UpSubstateFeeEntry) o;
    return Objects.equals(this.substateTypeIdentifier, upSubstateFeeEntry.substateTypeIdentifier) &&
        Objects.equals(this.fee, upSubstateFeeEntry.fee);
  }

  @Override
  public int hashCode() {
    return Objects.hash(substateTypeIdentifier, fee);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpSubstateFeeEntry {\n");
    sb.append("    substateTypeIdentifier: ").append(toIndentedString(substateTypeIdentifier)).append("\n");
