 ...
 */
@JsonPropertyOrder({
  Substate.JSON_PROPERTY_SUBSTATE_OPERATION,
  Substate.JSON_PROPERTY_SUBSTATE_IDENTIFIER
})
...
public class Substate {
  ...
  public static final String JSON_PROPERTY_SUBSTATE_OPERATION = "substate_operation";
  private SubstateOperationEnum substateOperation;

  public static final String JSON_PROPERTY_SUBSTATE_IDENTIFIER = "substate_identifier";
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The type of substate operation (equivalent to UTXO create/spend).")
  @JsonProperty(JSON_PROPERTY_SUBSTATE_OPERATION)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SUBSTATE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
