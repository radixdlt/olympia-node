...
@JsonPropertyOrder({
  ...
  Operation.JSON_PROPERTY_ENTITY_IDENTIFIER,
  Operation.JSON_PROPERTY_SUBSTATE,
  Operation.JSON_PROPERTY_AMOUNT,
  Operation.JSON_PROPERTY_DATA,
...
public class Operation {
  ...
  public static final String JSON_PROPERTY_SUBSTATE = "substate";
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The type of operation: Resource, Data, or ResourceAndData.")
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SUBSTATE)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Metadata for the operation.")
