 ...
 */
@JsonPropertyOrder({
  UpdateVoteResponse.JSON_PROPERTY_TRANSACTION_IDENTIFIER,
  UpdateVoteResponse.JSON_PROPERTY_DUPLICATE
})
...
public class UpdateVoteResponse {
  ...
  public UpdateVoteResponse transactionIdentifier(TransactionIdentifier transactionIdentifier) {
  ...
  **/
  ...
  public UpdateVoteResponse duplicate(Boolean duplicate) {
  ...
  **/
  ...
  /**
   * Return true if this UpdateVoteResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateVoteResponse updateVoteResponse = (UpdateVoteResponse) o;
    return Objects.equals(this.transactionIdentifier, updateVoteResponse.transactionIdentifier) &&
        Objects.equals(this.duplicate, updateVoteResponse.duplicate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionIdentifier, duplicate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateVoteResponse {\n");
