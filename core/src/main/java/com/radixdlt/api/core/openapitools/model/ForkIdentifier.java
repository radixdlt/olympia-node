 ...
 */
@JsonPropertyOrder({
  ForkIdentifier.JSON_PROPERTY_EPOCH,
  ForkIdentifier.JSON_PROPERTY_FORK
})
...
public class ForkIdentifier {
  public static final String JSON_PROPERTY_EPOCH = "epoch";
  private Long epoch;

  public static final String JSON_PROPERTY_FORK = "fork";
  private String fork;


  public ForkIdentifier epoch(Long epoch) {
    this.epoch = epoch;
    return this;
  }
  ...
  **/
  ...
  public ForkIdentifier fork(String fork) {
    this.fork = fork;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_FORK)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this ForkIdentifier object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ForkIdentifier forkIdentifier = (ForkIdentifier) o;
    return Objects.equals(this.epoch, forkIdentifier.epoch) &&
        Objects.equals(this.fork, forkIdentifier.fork);
  }

  @Override
  public int hashCode() {
    return Objects.hash(epoch, fork);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ForkIdentifier {\n");
