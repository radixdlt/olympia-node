 ...
 */
@JsonPropertyOrder({
  ValidatorAllowDelegation.JSON_PROPERTY_ALLOW_DELEGATION
})
...
public class ValidatorAllowDelegation extends DataObject {
  public static final String JSON_PROPERTY_ALLOW_DELEGATION = "allow_delegation";
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Flag indicating whether stakers besides the owner of the validator can stake to this validator.")
  ...
  /**
   * Return true if this ValidatorAllowDelegation object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("ValidatorAllowDelegation", ValidatorAllowDelegation.class);
  JSON.registerDiscriminator(ValidatorAllowDelegation.class, "type", mappings);
}
}
