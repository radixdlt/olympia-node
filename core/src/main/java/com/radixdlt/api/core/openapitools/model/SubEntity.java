 ...
 */
@JsonPropertyOrder({
  SubEntity.JSON_PROPERTY_ADDRESS,
  SubEntity.JSON_PROPERTY_METADATA
})
...
public class SubEntity {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The subentity.")
  ...
  **/
  ...
  /**
   * Return true if this SubEntity object is equal to o.
   */
  @Override
