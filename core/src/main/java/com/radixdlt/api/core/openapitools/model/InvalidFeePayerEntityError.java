 ...
 */
@JsonPropertyOrder({
  InvalidFeePayerEntityError.JSON_PROPERTY_INVALID_FEE_PAYER_ENTITY
})
...
public class InvalidFeePayerEntityError extends CoreError {
  ...
  public InvalidFeePayerEntityError invalidFeePayerEntity(EntityIdentifier invalidFeePayerEntity) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidFeePayerEntityError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidFeePayerEntityError invalidFeePayerEntityError = (InvalidFeePayerEntityError) o;
    return Objects.equals(this.invalidFeePayerEntity, invalidFeePayerEntityError.invalidFeePayerEntity) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidFeePayerEntityError {\n");
...
static {
  ...
  mappings.put("InvalidFeePayerEntityError", InvalidFeePayerEntityError.class);
  JSON.registerDiscriminator(InvalidFeePayerEntityError.class, "type", mappings);
}
}
