...
public class AboveMaximumValidatorFeeIncreaseError extends CoreError {
  ...
  public static final String JSON_PROPERTY_ATTEMPTED_VALIDATOR_FEE_INCREASE = "attempted_validator_fee_increase";
  ...
  **/
  ...
  public AboveMaximumValidatorFeeIncreaseError attemptedValidatorFeeIncrease(Integer attemptedValidatorFeeIncrease) {
   ...
   /**
   * Get attemptedValidatorFeeIncrease
   * @return attemptedValidatorFeeIncrease
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_ATTEMPTED_VALIDATOR_FEE_INCREASE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Integer getAttemptedValidatorFeeIncrease() {
    return attemptedValidatorFeeIncrease;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ATTEMPTED_VALIDATOR_FEE_INCREASE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAttemptedValidatorFeeIncrease(Integer attemptedValidatorFeeIncrease) {
    this.attemptedValidatorFeeIncrease = attemptedValidatorFeeIncrease;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maximumValidatorFeeIncrease, attemptedValidatorFeeIncrease, super.hashCode());
  }
