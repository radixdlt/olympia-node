 ...
 */
@JsonPropertyOrder({
  InvalidTransactionHashError.JSON_PROPERTY_INVALID_TRANSACTION_HASH
})
...
public class InvalidTransactionHashError extends CoreError {
  ...
  public InvalidTransactionHashError invalidTransactionHash(String invalidTransactionHash) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidTransactionHashError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidTransactionHashError invalidTransactionHashError = (InvalidTransactionHashError) o;
    return Objects.equals(this.invalidTransactionHash, invalidTransactionHashError.invalidTransactionHash) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidTransactionHashError {\n");
...
static {
  ...
  mappings.put("InvalidTransactionHashError", InvalidTransactionHashError.class);
  JSON.registerDiscriminator(InvalidTransactionHashError.class, "type", mappings);
}
}
