 ...
 */
@JsonPropertyOrder({
  ConstructionBuildResponse.JSON_PROPERTY_UNSIGNED_TRANSACTION,
  ConstructionBuildResponse.JSON_PROPERTY_PAYLOAD_TO_SIGN
})
...
public class ConstructionBuildResponse {
  ...
  public ConstructionBuildResponse unsignedTransaction(String unsignedTransaction) {
  ...
  **/
  ...
  public ConstructionBuildResponse payloadToSign(String payloadToSign) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Hex encoded hash payload to sign.")
  ...
  /**
   * Return true if this ConstructionBuildResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ConstructionBuildResponse constructionBuildResponse = (ConstructionBuildResponse) o;
    return Objects.equals(this.unsignedTransaction, constructionBuildResponse.unsignedTransaction) &&
        Objects.equals(this.payloadToSign, constructionBuildResponse.payloadToSign);
  }

  @Override
  public int hashCode() {
    return Objects.hash(unsignedTransaction, payloadToSign);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConstructionBuildResponse {\n");
