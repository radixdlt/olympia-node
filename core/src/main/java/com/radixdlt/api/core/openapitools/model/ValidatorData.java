 ...
 */
@JsonPropertyOrder({
  ValidatorData.JSON_PROPERTY_OWNER,
  ValidatorData.JSON_PROPERTY_REGISTERED,
  ValidatorData.JSON_PROPERTY_FEE
})
...
public class ValidatorData extends DataObject {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Flag indicating whether a validator is registered to be part of the validator set.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The fee percentage of the validator in 0.01% subunits (ie 10000 == 100%).")
  ...
  /**
   * Return true if this ValidatorData object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("ValidatorData", ValidatorData.class);
  JSON.registerDiscriminator(ValidatorData.class, "type", mappings);
}
}
