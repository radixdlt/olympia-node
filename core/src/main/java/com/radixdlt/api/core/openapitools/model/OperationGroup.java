 ...
 */
@JsonPropertyOrder({
  OperationGroup.JSON_PROPERTY_OPERATIONS,
  OperationGroup.JSON_PROPERTY_METADATA
})
...
public class OperationGroup {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "A group of operations representing a complete state update.")
  ...
  **/
  ...
  @ApiModelProperty(value = "Metadata for the operation group.")
  ...
  /**
   * Return true if this OperationGroup object is equal to o.
   */
  @Override
