...
public class ConstructionParseRequest {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Hex encoded transaction to parse.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Whether the transaction is signed or not. If not signed, parsing will skip authorization checks.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(networkIdentifier, transaction, signed);
  }
