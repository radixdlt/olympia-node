 ...
 */
@JsonPropertyOrder({
  ValidatorBFTData.JSON_PROPERTY_PROPOSALS_COMPLETED,
  ValidatorBFTData.JSON_PROPERTY_PROPOSALS_MISSED
})
...
public class ValidatorBFTData extends DataObject {
  ...
  **/
  ...
  /**
   * Return true if this ValidatorBFTData object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("ValidatorBFTData", ValidatorBFTData.class);
  JSON.registerDiscriminator(ValidatorBFTData.class, "type", mappings);
}
}
