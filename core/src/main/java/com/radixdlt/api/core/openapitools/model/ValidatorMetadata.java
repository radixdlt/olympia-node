 ...
 */
@JsonPropertyOrder({
  ValidatorMetadata.JSON_PROPERTY_NAME,
  ValidatorMetadata.JSON_PROPERTY_URL
})
...
public class ValidatorMetadata extends DataObject {
  ...
  **/
  ...
  /**
   * Return true if this ValidatorMetadata object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("ValidatorMetadata", ValidatorMetadata.class);
  JSON.registerDiscriminator(ValidatorMetadata.class, "type", mappings);
}
}
