 ...
 */
@JsonPropertyOrder({
  PreparedValidatorRegistered.JSON_PROPERTY_REGISTERED,
  PreparedValidatorRegistered.JSON_PROPERTY_EPOCH
})
...
public class PreparedValidatorRegistered extends DataObject {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The registered flag of the validator which will be updated by the end of `epoch`.")
  ...
  **/
  ...
  /**
   * Return true if this PreparedValidatorRegistered object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("PreparedValidatorRegistered", PreparedValidatorRegistered.class);
  JSON.registerDiscriminator(PreparedValidatorRegistered.class, "type", mappings);
}
}
