 ...
 */
@ApiModel(description = "A transaction which has been committed on ledger.")
@JsonPropertyOrder({
  CommittedTransaction.JSON_PROPERTY_TRANSACTION_IDENTIFIER,
  CommittedTransaction.JSON_PROPERTY_COMMITTED_STATE_IDENTIFIER,
  CommittedTransaction.JSON_PROPERTY_OPERATION_GROUPS,
  CommittedTransaction.JSON_PROPERTY_METADATA
})
...
public class CommittedTransaction {
  ...
  public static final String JSON_PROPERTY_COMMITTED_STATE_IDENTIFIER = "committed_state_identifier";
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_COMMITTED_STATE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Transactions are split into operation groups which are roughly equivalent to ledger accounting entries where all credits have an equivalent debit amount.")
