 ...
 */
@JsonPropertyOrder({
  InvalidAddressError.JSON_PROPERTY_INVALID_ADDRESS
})
...
public class InvalidAddressError extends CoreError {
  public static final String JSON_PROPERTY_INVALID_ADDRESS = "invalid_address";
  private String invalidAddress;


  public InvalidAddressError invalidAddress(String invalidAddress) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidAddressError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidAddressError invalidAddressError = (InvalidAddressError) o;
    return Objects.equals(this.invalidAddress, invalidAddressError.invalidAddress) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidAddressError {\n");
...
static {
  ...
  mappings.put("InvalidAddressError", InvalidAddressError.class);
  JSON.registerDiscriminator(InvalidAddressError.class, "type", mappings);
}
}
