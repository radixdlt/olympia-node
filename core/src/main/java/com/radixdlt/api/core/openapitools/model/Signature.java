...
public class Signature {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "An ECDSA signature of with the given `public_key`. The ECDSA signature should be created using the secp256k1 curve and should be encoded in DER format, and then encoded as a hex string.")
