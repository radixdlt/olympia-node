...
public class InvalidSignatureError extends CoreError {
  public static final String JSON_PROPERTY_INVALID_SIGNATURE = "invalid_signature";
  private String invalidSignature;


  public InvalidSignatureError invalidSignature(String invalidSignature) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidSignatureError object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("InvalidSignatureError", InvalidSignatureError.class);
  JSON.registerDiscriminator(InvalidSignatureError.class, "type", mappings);
}
}
