 ...
 */
@JsonPropertyOrder({
  InvalidPartialStateIdentifierError.JSON_PROPERTY_INVALID_PARTIAL_STATE_IDENTIFIER
})
...
public class InvalidPartialStateIdentifierError extends CoreError {
  ...
  public InvalidPartialStateIdentifierError invalidPartialStateIdentifier(PartialStateIdentifier invalidPartialStateIdentifier) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidPartialStateIdentifierError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidPartialStateIdentifierError invalidPartialStateIdentifierError = (InvalidPartialStateIdentifierError) o;
    return Objects.equals(this.invalidPartialStateIdentifier, invalidPartialStateIdentifierError.invalidPartialStateIdentifier) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidPartialStateIdentifierError {\n");
...
static {
  ...
  mappings.put("InvalidPartialStateIdentifierError", InvalidPartialStateIdentifierError.class);
  JSON.registerDiscriminator(InvalidPartialStateIdentifierError.class, "type", mappings);
}
}
