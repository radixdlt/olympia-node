...
public interface MessageCentral {
  ...
  /**
   * Sends a single message to a node. If required, the messaging system will establish a connection
   * to the peer, or re-use an existing connection.
   *
  ...
  /**
   * Closes this {@code MessageCentral} and releases any system resources associated with it. If it
