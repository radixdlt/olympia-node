 ...
 *
 * <p>This implementation works by scanning the classpath for classes annotated with {@code
 * SerializerConstants.SERIALIZER_ID_ANNOTATION} and passing these classes to {@link
...
public final class ClasspathScanningSerializationPolicy extends ClassScanningSerializationPolicy {
  ...
  /**
   * Note that this class is expensive to create, potentially in the order of several seconds for a
   * large classpath.
   *
