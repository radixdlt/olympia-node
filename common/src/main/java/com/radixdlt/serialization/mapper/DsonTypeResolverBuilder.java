 ...
 * serializable class set. This set consists of all classes annotated with {@link
 * com.radixdlt.serialization.SerializerId2} and their superclasses.
 */
class DsonTypeResolverBuilder extends ObjectMapper.DefaultTypeResolverBuilder {
  ...
  DsonTypeResolverBuilder(SerializerIds idLookup) {
    ...
    init(Id.CUSTOM, null)
        ...
        .typeProperty(SerializerConstants.SERIALIZER_NAME);
