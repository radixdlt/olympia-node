...
public class DsonFieldFilter extends SimpleBeanPropertyFilter {
   ...
   */
  public static FilterProvider filterProviderFor(
      ImmutableMap<Class<?>, ImmutableSet<String>> includedFields) {
    return new SimpleFilterProvider()
        .addFilter(MapperConstants.DSON_FILTER_NAME, new DsonFieldFilter(includedFields));
  }
