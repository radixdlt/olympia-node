...
/**
 * Post-processes executed tx batch. May be used for verification (throw PostProcessorException) or
 * extending the metadata with additional info before persisting (f.e.: forks hashes).
 *
