...
public class DifferentTimestampsCauseTimeoutTest {
	...
	public void when_four_nodes_receive_qcs_with_same_timestamps__quorum_is_achieved() {
		...
		processingSequence.add(Pair.of(ChannelId.of(3, 3), EpochViewUpdate.class));
		...
		processingSequence.add(Pair.of(ChannelId.of(0, 0), EpochViewUpdate.class));
		...
		processingSequence.add(Pair.of(ChannelId.of(1, 1), EpochViewUpdate.class));
		...
		processingSequence.add(Pair.of(ChannelId.of(2, 2), EpochViewUpdate.class));
	...
	private void addTwoViews(LinkedList<Pair<ChannelId, Class<?>>> processingSequence) {
		...
		processingSequence.add(Pair.of(ChannelId.of(1, 1), EpochViewUpdate.class)); // Messages to self first
