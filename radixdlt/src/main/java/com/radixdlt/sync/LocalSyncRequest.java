...
public final class LocalSyncRequest {
	private final VerifiedCommittedHeader target;
	private final ImmutableList<BFTNode> targetNodes;

	public LocalSyncRequest(VerifiedCommittedHeader target, ImmutableList<BFTNode> targetNodes) {
		this.target = Objects.requireNonNull(target);
		this.targetNodes = Objects.requireNonNull(targetNodes);
	}

	public VerifiedCommittedHeader getTarget() {
		return target;
	}
