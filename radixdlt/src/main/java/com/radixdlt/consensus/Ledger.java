...
public interface Ledger {
	 ...
	 */
	OnSynced ifCommitSynced(Header header);
	...
	/**
	 * Commit a command
	 * @param verifiedCommittedCommand the command to commit
	 */
	void commit(VerifiedCommittedCommand verifiedCommittedCommand);
}
