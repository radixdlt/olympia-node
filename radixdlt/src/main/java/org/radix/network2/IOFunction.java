...
/**
 * Implementation of {@link Function} that can throw an {@link IOException}.
 *
 * @param <T> The argument type for the function
...
public interface IOFunction<T, R> {
    ...
    /**
     * Wraps an {@link IOFunction} to throw an {@link UncheckedIOException}
     * if an exception is thrown.
     */
    static <V, U> Function<V, U> unchecked(IOFunction<V, U> f) {
