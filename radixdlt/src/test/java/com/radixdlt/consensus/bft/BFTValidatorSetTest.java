...
public class BFTValidatorSetTest {
	...
	public void testValidate() {
		...
		assertTrue(vst1.addSignature(node1, 0L, UInt256.ZERO, k1.sign(message)));
		assertFalse(vst1.complete());
		assertTrue(vst1.addSignature(node2, 0L, UInt256.ZERO, k2.sign(message)));
		assertFalse(vst1.complete());
		assertEquals(2, vst1.signatures().count());

		// 3 signatures for 4 validators -> pass
		ValidationState vst2 = vs.newValidationState();
		assertTrue(vst2.addSignature(node1, 0L, UInt256.ZERO, k1.sign(message)));
		assertFalse(vst1.complete());
		assertTrue(vst2.addSignature(node2, 0L, UInt256.ZERO, k2.sign(message)));
		assertFalse(vst1.complete());
		assertTrue(vst2.addSignature(node3, 0L, UInt256.ZERO, k3.sign(message)));
		...
		assertTrue(vst3.addSignature(node1, 0L, UInt256.ZERO, k1.sign(message)));
		assertFalse(vst3.complete());
		assertTrue(vst3.addSignature(node2, 0L, UInt256.ZERO, k2.sign(message)));
		assertFalse(vst3.complete());
		assertFalse(vst3.addSignature(node5, 0L, UInt256.ZERO, k5.sign(message)));
		assertFalse(vst3.complete());
		...
		assertTrue(vst4.addSignature(node1, 0L, UInt256.ZERO, k1.sign(message)));
		assertFalse(vst3.complete());
		assertTrue(vst4.addSignature(node2, 0L, UInt256.ZERO, k2.sign(message)));
		assertFalse(vst3.complete());
		assertFalse(vst4.addSignature(node5, 0L, UInt256.ZERO, k5.sign(message)));
		assertFalse(vst3.complete());
		assertTrue(vst4.addSignature(node3, 0L, UInt256.ZERO, k3.sign(message)));
