...
public class VertexTest {
	...
	public void setUp() {
		...
		Header header = new Header(0, baseView.next(), id, Hash.random(), mock(LedgerState.class));
		Header parent = new Header(0, baseView, Hash.random(), Hash.random(), mock(LedgerState.class));
