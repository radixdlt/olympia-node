...
public class VertexTest {
	...
	public void setUp() {
		...
		VertexMetadata vertexMetadata = new VertexMetadata(0, baseView.next(), id, 1, null, Hash.ZERO_HASH);
		VertexMetadata parent = new VertexMetadata(0, baseView, Hash.random(), 0, null, Hash.ZERO_HASH);
