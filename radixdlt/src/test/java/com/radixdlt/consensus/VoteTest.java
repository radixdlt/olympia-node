...
public class VoteTest {
	...
	@Before
	public void setUp() {
		BFTHeader parent = new BFTHeader(View.of(1234567890L), Hash.random(), mock(LedgerState.class));
		this.voteData = new VoteData(BFTHeader.ofGenesisAncestor(mock(LedgerState.class)), parent, null);
