...
public class UInt384Test {
	...
	public void when_multiplying_two_values__the_correct_value_is_returned() {
		...
		assertEquals(UInt384.from(12345678L * 13L), UInt384.from(12345678L).multiply(UInt384.from(13L)));
	}
	...
	public void when_dividing_one_value_by_another_int256__the_correct_value_is_returned() {
		...
		assertEquals(UInt384.ONE.shiftLeft(UInt384.SIZE - UInt256.SIZE), UInt384.MAX_VALUE.divide(UInt256.MAX_VALUE));
	...
	public void when_converting_int256_to_byte_array__the_correct_values_are_returned() {
		...
		UInt256 bp1 = UInt256.from(UInt128.from(0x1011_1213_1415_1617L, 0x1819_1A1B_1C1D_1E1FL), UInt128.from(0x2021_2223_2425_2627L, 0x2829_2A2B_2C2D_2E2FL));
	...
	public void when_performing_binary_shifts__the_correct_value_is_returned() {
		...
		// Make sure bit crosses word boundary correctly
		assertEquals(UInt384.from(UInt128.ZERO, UInt256.HIGH_BIT), UInt384.from(UInt128.ONE, UInt256.ZERO).shiftRight());
	}
