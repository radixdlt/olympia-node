...
public class GreedyFungibleMatcherTest {
	...
	public void testMatch() {
		...
		FungibleTransitionMatch uraniumTransitionMatch = new FungibleTransitionMatch(h2OTransition, Collections.singletonList(uraniumMatch), FungibleOutputs.of());
	...
	public void testMatchTransition() {
		...
		FungibleTransitionMatchResult transitionMatchResult = GreedyFungibleMatcher.matchTransition(transition, fungibleInputs, fungibleOutputs, metadata,
