...
public final class DefaultHDPath {
  ...
  /**
   * Tries to create a {@link HDPath} instance from the given {@code path}. If said path is not a
   * valid HDPath, an exception will be thrown.
   *
   * @param path a string representing a hierarchy deterministic path, typically <a
