...
/**
 * Converter of a <a href="https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki">BIP39
 * (BIP-39)</a> mnemonic code, to a seed (byte array) used to create some (HD root) key pair.
 */
public final class DefaultMnemonicToSeedConverter {
  ...
  /**
   * Returns a binary seed from a BIP39 mnemonic string (assuming a space is used to separate the
   * words) + provided passphrase
   *
  ...
  public static byte[] seedFromMnemonicStringAndPassphrase(String mnemonic, String passphrase)
      throws MnemonicException {
    return BitcoinJMnemonicToSeedConverter.seedFromMnemonicStringAndPassphrase(
        mnemonic, passphrase);
  }

  /**
   * Returns a binary seed from a BIP39 mnemonic string (assuming a space is used to separate the
   * words), using an empty passphrase ({@code ""})
   *
   * @param mnemonic a BIP39 mnemonic string (assuming a space is used to separate the words)
   * @return a binary seed from a list of BIP39 mnemonic words, using an empty passphrase ({@code
   *     ""})
  ...
  /**
   * Validates the list of words to see if they form a valid BIP39 mnemonic, if the words are
  ...
  /**
   * Return {@code true} iff the mnemonic {@code words} form a valid BIP39 mnemonic, else {@code
   * false } is returned.
   *
   * @param words a list of words to check if they form a valid BIP39 mnemonic.
   */
  ...
  /**
   * Validates the {@code mnemonic} string (assuming a space is used to separate the words), form a
   * valid BIP39 mnemonic, if the words are invalid an exception is thrown.
   *
   * @param mnemonic a BIP39 mnemonic string (assuming a space is used to separate the words)
   * @throws MnemonicException thrown if the {@code mnemonic} is invalid.
   */
  ...
  /**
   * Return {@code true} iff the {@code mnemonic} string (assuming a space is used to separate the
   * words) form a valid BIP39 mnemonic, else {@code false } is returned.
   *
   * @param mnemonic a BIP39 mnemonic string (assuming a space is used to separate the words)
   */
