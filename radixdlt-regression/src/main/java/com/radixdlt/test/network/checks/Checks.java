...
public class Checks {
  ...
  public static Checks forNodesAndCheckConfiguration(
      List<RadixNode> nodes, RadixNetworkConfiguration configuration) {
  ...
  private Checks(List<RadixNode> nodes, RadixNetworkConfiguration configuration) {
    ...
    var livenessCheck =
        new LivenessCheck(nodes, 3, RadixHttpClient.fromRadixNetworkConfiguration(configuration));
