...
public class UniverseUtils {
  ...
  public static UniverseVariables generateEnvironmentVariables(int numberOfValidators) {
    ...
    var keyPairs =
        IntStream.range(0, numberOfValidators)
            .mapToObj(index -> new ValidatorKeypair())
    ...
    for (String outputLine : output) {
      ...
      if (outputLine.contains("PUBKEY")) {
        ...
        var validatorNumber =
            Integer.parseInt(StringUtils.substringBetween(outputLine, "VALIDATOR_", "_PUBKEY"));
        ...
        var validatorNumber =
            Integer.parseInt(StringUtils.substringBetween(outputLine, "VALIDATOR_", "_PRIVKEY"));
