...
public class ValidatorsResponseDTO {
	private final NavigationCursor cursor;
	private final List<ValidatorDTO> validators;

	private ValidatorsResponseDTO(NavigationCursor cursor, List<ValidatorDTO> validators) {
		this.cursor = cursor;
		this.validators = validators;
	}

	@JsonCreator
	public static ValidatorsResponseDTO create(
		...
		return new ValidatorsResponseDTO(cursor, validators);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ValidatorsResponseDTO)) {
			return false;
		}

		var that = (ValidatorsResponseDTO) o;
