...
public class TransactionRequest {
  ...
  private TransactionRequest(
      ...
      Boolean disableResourceAllocationAndDestroy) {
  ...
  public static final class TransactionRequestBuilder {
    ...
    public TransactionRequestBuilder transfer(
        AccountAddress from, AccountAddress to, UInt256 amount, String rri) {
      actions.add(new TransferAction(from, to, amount, rri));
      return this;
    }

    public TransactionRequestBuilder stake(
        AccountAddress from, ValidatorAddress validator, UInt256 amount) {
      actions.add(new StakeAction(from, validator, amount));
      return this;
    }

    public TransactionRequestBuilder unstake(
        AccountAddress to, ValidatorAddress validator, UInt256 amount) {
    ...
    public TransactionRequestBuilder registerValidator(
    ...
    public TransactionRequestBuilder unregisterValidator(
        ValidatorAddress validator, Optional<String> name, Optional<String> url) {
    ...
    public TransactionRequestBuilder updateValidatorAllowDelegationFlag(
    ...
    public TransactionRequestBuilder updateValidatorFee(
        ValidatorAddress validator, double validatorFee) {
      actions.add(new UpdateValidatorFeeAction(validator, validatorFee));
      return this;
    }

    public TransactionRequestBuilder updateValidatorOwner(
        ValidatorAddress validator, AccountAddress owner) {
    ...
    public TransactionRequestBuilder createFixed(
        ...
        UInt256 supply) {
      actions.add(
          new CreateFixedTokenAction(
              to, publicKeyOfSigner, symbol, name, description, iconUrl, tokenUrl, supply));
      return this;
    }
    ...
    public TransactionRequest build() {
      return new TransactionRequest(
          message, actions, feePayer, disableResourceAllocationAndDestroy);
    }
  }
}
