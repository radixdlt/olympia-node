 ...
 *
 * This version of the API converts functional style synchronous API's into more traditional "throw
 * if error"-style Java API.
 *
...
public interface ImperativeRadixApi {
   ...
   * @return created client
   */
  static ImperativeRadixApi connect(
      String baseUrl, int primaryPort, int secondaryPort, BasicAuth authentication) {
    return toImperative(
        unwrap(RadixApi.connect(baseUrl, primaryPort, secondaryPort, authentication)));
  }
