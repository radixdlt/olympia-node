...
public class TransactionHistory2 {
	...
	private TransactionHistory2(Long nextOffset, List<TransactionDTO> transactions) {
	...
	public static TransactionHistory2 create(
		...
		return new TransactionHistory2(nextOffset, transactions);
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(nextOffset, that.nextOffset)
	...
	public String toString() {
		return "TransactionHistory(" + "nextOffset=" + nextOffset + ", transactions=" + transactions + ')';
	}
