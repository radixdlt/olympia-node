...
public class AsyncRadixApiSyncTest {
  ...
  private static final String CONFIGURATION =
      "{\"result\":{\"maxLedgerUpdatesRate\":50,\"syncCheckMaxPeers\":10,\"ledgerStatusUpdateMaxPeersToNotify\":10,\"syncCheckInterval\":3000,\"requestTimeout\":5000},\"id\":\"2\",\"jsonrpc\":\"2.0\"}\n";
  private static final String DATA =
      "{\"result\":{\"processed\":36898,\"invalidCommandsReceived\":0,\"targetCurrentDiff\":0,\"remoteRequestsProcessed\":38614,\"lastReadMillis\":0,\"targetStateVersion\":814181},\"id\":\"2\",\"jsonrpc\":\"2.0\"}\n";
        ...
        .onSuccess(
            client ->
                client
                    ...
                    .onFailure(failure -> fail(failure.toString()))
                    .onSuccess(
                        configuration -> assertEquals(50L, configuration.getMaxLedgerUpdatesRate()))
                    .onSuccess(
                        configuration -> assertEquals(3000, configuration.getSyncCheckInterval())));
  }
