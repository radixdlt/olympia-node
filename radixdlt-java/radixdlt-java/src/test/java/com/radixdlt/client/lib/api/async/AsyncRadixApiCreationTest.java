...
public class AsyncRadixApiCreationTest {
  ...
  private static final AccountAddress ACCOUNT_ADDRESS3 =
      AccountAddress.create(KEY_PAIR3.getPublicKey());
  private static final ValidatorAddress VALIDATOR_ADDRESS =
      ValidatorAddress.of(KEY_PAIR3.getPublicKey());

  private static final String NETWORK_ID =
      "{\"result\":{\"networkId\":2},\"id\":\"1\",\"jsonrpc\":\"2.0\"}";
  private static final String BUILT_TRANSACTION =
      "{\"result\":{\"fee\":\"73800000000000000\",\"transaction\":{\"blob\":"
  ...
  private static final String BLOB =
      "060a104c95b2f14ca1c6500b519ad696bee17b7a982810c5e4fe43d39b979bfbc300000001012100"
  ...
  private static final String TX_ID =
      "a84843d8c51f92a872a926cd29a2074f1c85bf47392a2fd0e41a4272e38f1aa5";
  private static final String SIG =
      "3045022100f179714d7577a105d0a37891bc149ed6ba519435dcc53340f0467611e0d31bb40220388"
  ...
  private static final String FINALIZE_TRANSACTION =
      "{\"result\":{\"blob\":\"060a104c95b2f14ca1c6500b519ad696bee17b7a"
  ...
  private static final String SUBMIT_TRANSACTION =
      "{\"result\":{\"txID\":\"a84843d8c51f92a872a926cd29a2074f1c85bf4739"
        ...
        .onSuccess(
            client ->
                client
                    ...
                    .onSuccess(
                        dto -> assertArrayEquals(hash, dto.getTransaction().getHashToSign())));
  }
        ...
        .onSuccess(
            client ->
                client
                    ...
                    .onSuccess(
                        builtTransaction ->
                            assertEquals(amount(73800).micros(), builtTransaction.getFee()))
                    .map(builtTransaction -> builtTransaction.toFinalized(KEY_PAIR1))
                    .onSuccess(
                        finalizedTransaction ->
                            client
                                .transaction()
                                .finalize(finalizedTransaction, true)
                                .join()
                                .onFailure(failure -> fail(failure.toString()))));
  }
        ...
        .onSuccess(
            client ->
                client
                    ...
                    .onSuccess(
                        builtTransaction ->
                            assertEquals(amount(1000109).millis(), builtTransaction.getFee()))
                    .map(builtTransaction -> builtTransaction.toFinalized(KEY_PAIR1))
                    .onSuccess(
                        finalizedTransaction ->
                            client
  ...
  public void testRegisterValidator() {
    var request =
        TransactionRequest.createBuilder(ACCOUNT_ADDRESS3)
            .registerValidator(
                VALIDATOR_ADDRESS,
                Optional.of("MyValidator"),
                Optional.of("http://my.validator.url.com/"))
        ...
        .onSuccess(
            client ->
                client
                    ...
                    .onSuccess(
                        builtTransaction ->
                            assertEquals(amount(102600).micros(), builtTransaction.getFee()))
