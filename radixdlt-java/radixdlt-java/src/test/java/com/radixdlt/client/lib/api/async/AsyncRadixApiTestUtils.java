...
public final class AsyncRadixApiTestUtils {
	...
	private AsyncRadixApiTestUtils() {
	}

	public static Promise<RadixApi> prepareClient(String... responseBodies) throws IOException {
		if (RUN_ONLINE) {
