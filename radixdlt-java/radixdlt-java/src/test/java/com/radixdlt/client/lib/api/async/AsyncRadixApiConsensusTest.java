...
public class AsyncRadixApiConsensusTest {
  ...
  private static final String CONFIGURATION =
      "{\"result\":{\"pacemakerTimeout\":3000,\"bftSyncPatienceMs\":200},"
          + "\"id\":\"2\",\"jsonrpc\":\"2.0\"}\n";
  private static final String DATA =
      "{\"result\":{\"timeoutQuorums\":1,\"rejected\":0,\"voteQuorums\":79981,\"vertexStoreForks\":1,\"sync\":{\"requestsSent\":0,\"requestTimeouts\":0},\"timeout\":1,\"stateVersion\":159960,\"processed\":159959,\"timedOutViews\":1,\"vertexStoreSize\":2,\"vertexStoreRebuilds\":0,\"consensusEvents\":319926,\"indirectParent\":1,\"proposalsMade\":79981},\"id\":\"2\",\"jsonrpc\":\"2.0\"}\n";
        ...
        .onSuccess(
            client ->
                client
                    ...
                    .onFailure(failure -> fail(failure.toString()))
                    .onSuccess(
                        configuration -> assertEquals(200L, configuration.getBftSyncPatienceMs()))
                    .onSuccess(
                        configuration -> assertEquals(3000L, configuration.getPacemakerTimeout())));
  }
