...
public class ValidatorsGetNextEpochSetRequest {
	...
	private ValidatorsGetNextEpochSetRequest(long size, Optional<NavigationCursor> cursor) {
		this.size = size;
		this.cursor = cursor;
	}
	...
	public static ValidatorsGetNextEpochSetRequest create(
		...
		return new ValidatorsGetNextEpochSetRequest(size, cursor);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ValidatorsGetNextEpochSetRequest)) {
			return false;
		}

		var that = (ValidatorsGetNextEpochSetRequest) o;
