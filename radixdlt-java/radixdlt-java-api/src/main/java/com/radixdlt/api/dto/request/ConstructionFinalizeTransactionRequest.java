...
public class ConstructionFinalizeTransactionRequest implements MethodParameters {
	...
	private ConstructionFinalizeTransactionRequest(byte[] rawBlob, ECDSASignature rawSignature, ECPublicKey publicKey, boolean immediateSubmit) {
	...
	@JsonCreator
	public static ConstructionFinalizeTransactionRequest create(
		...
		return new ConstructionFinalizeTransactionRequest(
			Hex.decode(blob),
	...
	public static ConstructionFinalizeTransactionRequest from(
		byte[] rawBlob,
		ECDSASignature rawSignature,
		ECPublicKey publicKey,
		boolean immediateSubmit
	) {
		return new ConstructionFinalizeTransactionRequest(rawBlob, rawSignature, publicKey, immediateSubmit);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ConstructionFinalizeTransactionRequest)) {
			return false;
		}

		var that = (ConstructionFinalizeTransactionRequest) o;
