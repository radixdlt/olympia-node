...
public class RadixClientSelectorTest {
	@Test
	public void failedNodeConnectionTest() {
		...
		RadixClientSelector radixClientSelector = new RadixClientSelector(config, network, false);
		TestObserver<RadixJsonRpcClient> testObserver = TestObserver.create();
		radixClientSelector.getRadixClient(1L).subscribe(testObserver);
