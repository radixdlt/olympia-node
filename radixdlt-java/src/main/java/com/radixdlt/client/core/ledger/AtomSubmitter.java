...
public class AtomSubmitter {
	private static final Logger LOGGER = LoggerFactory.getLogger(AtomSubmitter.class);

	private final Function<Set<Long>, Single<RadixJsonRpcClient>> clientSelector;

	public AtomSubmitter(Function<Set<Long>, Single<RadixJsonRpcClient>> clientSelector) {
