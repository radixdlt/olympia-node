...
import static com.radixdlt.errors.ConversionError.UNABLE_TO_PARSE_UINT;
...
public final class UInt256 implements Comparable<UInt256> {
	...
	public UInt256 add(UInt256 other) {
		...
		long partial1 = (this.low.midLow & INT_MASK) + (other.low.midLow & INT_MASK) + (partial0 >>> Integer.SIZE);
		long partial2 = (this.low.midHigh & INT_MASK) + (other.low.midHigh & INT_MASK) + (partial1 >>> Integer.SIZE);
		long partial3 = (this.low.high & INT_MASK) + (other.low.high & INT_MASK) + (partial2 >>> Integer.SIZE);
		long partial4 = (this.high.low & INT_MASK) + (other.high.low & INT_MASK) + (partial3 >>> Integer.SIZE);
		long partial5 = (this.high.midLow & INT_MASK) + (other.high.midLow & INT_MASK) + (partial4 >>> Integer.SIZE);
	...
	public UInt256 add(UInt128 other) {
		...
		long partial1 = (this.low.midLow & INT_MASK) + (other.midLow & INT_MASK) + (partial0 >>> Integer.SIZE);
		long partial2 = (this.low.midHigh & INT_MASK) + (other.midHigh & INT_MASK) + (partial1 >>> Integer.SIZE);
		long partial3 = (this.low.high & INT_MASK) + (other.high & INT_MASK) + (partial2 >>> Integer.SIZE);
