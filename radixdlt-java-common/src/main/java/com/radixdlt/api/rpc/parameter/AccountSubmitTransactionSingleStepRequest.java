...
public class AccountSubmitTransactionSingleStepRequest implements MethodParameters {
	...
	public static AccountSubmitTransactionSingleStepRequest from(TransactionRequest request) {
		return new AccountSubmitTransactionSingleStepRequest(request.getActions(), request.getMessage());
	}
