...
/**
 * Errors related to data conversion.
 * For example, errors during transformation/serialization/deserialization/formatting/etc.
 * <p>
...
public enum ConversionError implements Failure {
	...
	@Override
	public int code() {
		return Category.CONVERSION.forId(ordinal());
	}
}
