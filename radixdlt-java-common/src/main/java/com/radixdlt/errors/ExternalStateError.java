...
/**
 * Errors caused by incompatibility with current external state.
 * For example: not enough funds, not enough funds for fee, etc.
 * <p>
...
public enum ExternalStateError implements Failure {
	...
	ExternalStateError(String message) {
	...
	@Override
	public int code() {
		return Category.EXTERNAL_STATE.forId(ordinal());
	}
}
