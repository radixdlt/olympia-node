...
public interface SerializerIds {
  ...
  /**
   * Return an object's class, given the ID. If the serializer ID is unknown, {@code null} is
   * returned.
   *
   * @param id The serializer ID to find the mapped class for.
   * @return The class corresponding to the serializer ID, or {@code null} if serializer ID unknown.
   */
  Class<?> getClassForId(String id);

  /**
   * Return true if class is serializable, or a supertype of a serializable class, excluding {@code
   * Object}.
   *
