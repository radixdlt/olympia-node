 ...
 * <p>
 * Test vectors used have been taken from
...
public class SHAHashHandlerTest {
	...
	public void testVector1Sha256() {
		...
		testSha256("abc", sha256("ba7816bf 8f01cfea 414140de 5dae2223 b00361a3 96177a9c b410ff61 f20015ad"));
	}

	@Test
	public void testVector2Sha256() {
		// Input message: the empty string "", the bit string of length 0.
		testSha256("", sha256("e3b0c442 98fc1c14 9afbf4c8 996fb924 27ae41e4 649b934c a495991b 7852b855"));
	}
	...
	public void testVector3Sha512() {
		...
		testSha512(
			"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
			sha512("204a8fc6dda82f0a 0ced7beb8e08a416 57c16ef468b228a8 279be331a703c335"
	...
	public void testVector4Sha512() {
		...
		testSha512(
			"abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
			sha512("8e959b75dae313da 8cf4f72814fc143f 8f7779c6eb9f7fa1 7299aeadb6889018"
	...
	public void testVector5Sha512() {
		...
		testSha512(
			"a".repeat(1_000_000),
			sha512("e718483d0ce76964 4e2e42c7bc15b463 8e1f98b13b204428 5632a803afa973eb"
