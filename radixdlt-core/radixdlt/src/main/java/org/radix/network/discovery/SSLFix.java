...
class SSLFix {
  ...
  static X509ExtendedTrustManager[] trustAllHosts() {
    try {
      X509ExtendedTrustManager[] trustAllCerts =
          new X509ExtendedTrustManager[] {
            new X509ExtendedTrustManager() {
              ...
              @Override
              public void checkClientTrusted(
                  java.security.cert.X509Certificate[] xcs, String string, Socket socket)
                  throws CertificateException {
                checkClient();
              }
              ...
              @Override
              public void checkClientTrusted(
                  java.security.cert.X509Certificate[] xcs, String string, SSLEngine ssle)
                  throws CertificateException {
                checkClient();
              }
