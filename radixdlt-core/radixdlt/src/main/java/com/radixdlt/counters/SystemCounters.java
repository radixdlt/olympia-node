...
public interface SystemCounters {
	...
	enum CounterType {
		...
		NETWORKING_P2P_SENT_BYTES("networking.p2p.sent_bytes"),
		NETWORKING_P2P_AVG_SENT_MSG_SIZE("networking.p2p.avg_sent_msg_size"),
		NETWORKING_P2P_RECEIVED_BYTES("networking.p2p.received_bytes"),
		NETWORKING_P2P_AVG_RECEIVED_MSG_SIZE("networking.p2p.avg_received_msg_size"),
		NETWORKING_P2P_DROPPED_MESSAGES("networking.p2p.dropped_messages"),
		...
		NETWORKING_P2P_CHANNELS_CLOSED("networking.p2p.channels_closed"),
