...
public final class AddressBookEntry {
  ...
  public static AddressBookEntry createBanned(NodeId nodeId, Instant bannedUntil) {
    return new AddressBookEntry(
        nodeId, Optional.of(bannedUntil), ImmutableSet.of(), ImmutableSet.of());
  }
  ...
  public static AddressBookEntry createWithProxyCertificates(
      NodeId nodeId, ImmutableSet<VerifiedProxyCertificate> proxyCertificates) {
  ...
  public AddressBookEntry withProxyCertificates(
      ImmutableSet<VerifiedProxyCertificate> proxyCertificates) {
  ...
  public String toString() {
    return String.format(
        "%s[nodeId=%s, bannedUntil=%s, knownAddresses=%s, proxyCerts=%s]",
        getClass().getSimpleName(), nodeId, bannedUntil, knownAddresses, proxyCertificates);
  }
