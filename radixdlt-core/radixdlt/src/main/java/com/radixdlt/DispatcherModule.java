...
public class DispatcherModule extends AbstractModule {
  ...
  private void configureP2p() {
    ...
    bind(new TypeLiteral<RemoteEventDispatcher<GetPeers>>() {})
        ...
        .in(Scopes.SINGLETON);
    bind(new TypeLiteral<RemoteEventDispatcher<GetProxiedPeers>>() {})
        .toProvider(Dispatchers.remoteDispatcherProvider(GetProxiedPeers.class))
        .in(Scopes.SINGLETON);
    bind(new TypeLiteral<RemoteEventDispatcher<PeersResponse>>() {})
        ...
        .in(Scopes.SINGLETON);
    bind(new TypeLiteral<RemoteEventDispatcher<ProxiedPeersResponse>>() {})
        .toProvider(Dispatchers.remoteDispatcherProvider(ProxiedPeersResponse.class))
        .in(Scopes.SINGLETON);
    bind(new TypeLiteral<EventDispatcher<DiscoverPeers>>() {})
        .toProvider(Dispatchers.dispatcherProvider(DiscoverPeers.class))
        .in(Scopes.SINGLETON);
    bind(new TypeLiteral<RemoteEventDispatcher<GrantedProxyCertificate>>() {})
        .toProvider(Dispatchers.remoteDispatcherProvider(GrantedProxyCertificate.class))
        .in(Scopes.SINGLETON);
    bind(new TypeLiteral<RemoteEventDispatcher<ProxyCertificatesAnnouncement>>() {})
        .toProvider(Dispatchers.remoteDispatcherProvider(ProxyCertificatesAnnouncement.class))
        .in(Scopes.SINGLETON);
