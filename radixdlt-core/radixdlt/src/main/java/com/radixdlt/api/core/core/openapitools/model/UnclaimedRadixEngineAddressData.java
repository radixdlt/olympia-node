...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-29T10:28:43.781511-06:00[America/Chicago]")
...
public class UnclaimedRadixEngineAddressData extends DataObject {

  /**
   * Return true if this UnclaimedRadixEngineAddressData object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class UnclaimedRadixEngineAddressData {\n");
...
static {
  ...
  mappings.put("UnclaimedRadixEngineAddressData", UnclaimedRadixEngineAddressData.class);
  JSON.registerDiscriminator(UnclaimedRadixEngineAddressData.class, "type", mappings);
}
}
