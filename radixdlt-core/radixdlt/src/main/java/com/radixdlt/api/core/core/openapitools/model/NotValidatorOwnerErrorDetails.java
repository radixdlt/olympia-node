...
/**
 * NotValidatorOwnerErrorDetails
 */
@JsonPropertyOrder({
  NotValidatorOwnerErrorDetails.JSON_PROPERTY_OWNER,
  NotValidatorOwnerErrorDetails.JSON_PROPERTY_USER
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-28T21:39:58.855598-06:00[America/Chicago]")
...
public class NotValidatorOwnerErrorDetails extends ErrorDetails {
  ...
  public NotValidatorOwnerErrorDetails owner(EntityIdentifier owner) {
    this.owner = owner;
    return this;
  }
  ...
  **/
  ...
  public NotValidatorOwnerErrorDetails user(EntityIdentifier user) {
    this.user = user;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this NotValidatorOwnerErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NotValidatorOwnerErrorDetails notValidatorOwnerErrorDetails = (NotValidatorOwnerErrorDetails) o;
    return Objects.equals(this.owner, notValidatorOwnerErrorDetails.owner) &&
        Objects.equals(this.user, notValidatorOwnerErrorDetails.user) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotValidatorOwnerErrorDetails {\n");
...
static {
  ...
  mappings.put("NotValidatorOwnerErrorDetails", NotValidatorOwnerErrorDetails.class);
  JSON.registerDiscriminator(NotValidatorOwnerErrorDetails.class, "type", mappings);
}
}
