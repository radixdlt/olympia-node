...
public final class InvalidAddressException extends CoreModelException {
	private final String invalidAddress;

	public InvalidAddressException(String invalidAddress) {
	...
	public ErrorDetails getErrorDetails() {
		return new InvalidAddressErrorDetails()
			.invalidAddress(invalidAddress)
			.type(InvalidAddressErrorDetails.class.getSimpleName());
	}
}
