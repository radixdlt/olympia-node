...
/**
 * InvalidPartialStateIdentifierErrorDetails
 */
@JsonPropertyOrder({
  InvalidPartialStateIdentifierErrorDetails.JSON_PROPERTY_INVALID_PARTIAL_STATE_IDENTIFIER
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-28T13:39:26.577722-06:00[America/Chicago]")
...
public class InvalidPartialStateIdentifierErrorDetails extends ErrorDetails {
  public static final String JSON_PROPERTY_INVALID_PARTIAL_STATE_IDENTIFIER = "invalid_partial_state_identifier";
  private PartialStateIdentifier invalidPartialStateIdentifier;


  public InvalidPartialStateIdentifierErrorDetails invalidPartialStateIdentifier(PartialStateIdentifier invalidPartialStateIdentifier) {
    this.invalidPartialStateIdentifier = invalidPartialStateIdentifier;
    return this;
  }

   /**
   * Get invalidPartialStateIdentifier
   * @return invalidPartialStateIdentifier
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_INVALID_PARTIAL_STATE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public PartialStateIdentifier getInvalidPartialStateIdentifier() {
    return invalidPartialStateIdentifier;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INVALID_PARTIAL_STATE_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvalidPartialStateIdentifier(PartialStateIdentifier invalidPartialStateIdentifier) {
    this.invalidPartialStateIdentifier = invalidPartialStateIdentifier;
  }


  /**
   * Return true if this InvalidPartialStateIdentifierErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidPartialStateIdentifierErrorDetails invalidPartialStateIdentifierErrorDetails = (InvalidPartialStateIdentifierErrorDetails) o;
    return Objects.equals(this.invalidPartialStateIdentifier, invalidPartialStateIdentifierErrorDetails.invalidPartialStateIdentifier) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidPartialStateIdentifier, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvalidPartialStateIdentifierErrorDetails {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    invalidPartialStateIdentifier: ").append(toIndentedString(invalidPartialStateIdentifier)).append("\n");
    sb.append("}");
    return sb.toString();
  }
...
static {
  ...
  mappings.put("InvalidPartialStateIdentifierErrorDetails", InvalidPartialStateIdentifierErrorDetails.class);
  JSON.registerDiscriminator(InvalidPartialStateIdentifierErrorDetails.class, "type", mappings);
}
}
