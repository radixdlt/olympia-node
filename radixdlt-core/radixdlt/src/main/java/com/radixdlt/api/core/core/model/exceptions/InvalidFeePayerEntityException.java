...
public final class InvalidFeePayerEntityException extends CoreModelException {
	private final EntityIdentifier entityIdentifier;

	public InvalidFeePayerEntityException(EntityIdentifier entityIdentifier) {
	...
	public ErrorDetails getErrorDetails() {
		return new InvalidFeePayerEntityErrorDetails()
