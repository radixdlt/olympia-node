...
public class ConstructionParseResponse {
  ...
  private ConstructionParseResponseMetadata metadata;
  ...
  **/
  ...
  public ConstructionParseResponse metadata(ConstructionParseResponseMetadata metadata) {
  ...
  **/
  ...
  public ConstructionParseResponseMetadata getMetadata() {
    return metadata;
  }
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(ConstructionParseResponseMetadata metadata) {
    this.metadata = metadata;
  }
