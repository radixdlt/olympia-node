...
/**
 * InvalidPublicKeyErrorDetails
 */
@JsonPropertyOrder({
  InvalidPublicKeyErrorDetails.JSON_PROPERTY_INVALID_PUBLIC_KEY
})
...
public class InvalidPublicKeyErrorDetails extends ErrorDetails {
  public static final String JSON_PROPERTY_INVALID_PUBLIC_KEY = "invalid_public_key";
  private PublicKey invalidPublicKey;


  public InvalidPublicKeyErrorDetails invalidPublicKey(PublicKey invalidPublicKey) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidPublicKeyErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidPublicKeyErrorDetails invalidPublicKeyErrorDetails = (InvalidPublicKeyErrorDetails) o;
    return Objects.equals(this.invalidPublicKey, invalidPublicKeyErrorDetails.invalidPublicKey) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidPublicKeyErrorDetails {\n");
...
static {
  ...
  mappings.put("InvalidPublicKeyErrorDetails", InvalidPublicKeyErrorDetails.class);
  JSON.registerDiscriminator(InvalidPublicKeyErrorDetails.class, "type", mappings);
}
}
