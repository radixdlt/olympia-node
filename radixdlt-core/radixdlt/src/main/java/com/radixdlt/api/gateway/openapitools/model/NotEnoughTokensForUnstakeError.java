...
@JsonPropertyOrder({
  ...
  NotEnoughTokensForUnstakeError.JSON_PROPERTY_PENDING_STAKED_AMOUNT,
  NotEnoughTokensForUnstakeError.JSON_PROPERTY_AVAILABLE_STAKED_AMOUNT
})
...
public class NotEnoughTokensForUnstakeError extends GatewayError {
  ...
  public static final String JSON_PROPERTY_PENDING_STAKED_AMOUNT = "pending_staked_amount";
  private TokenAmount pendingStakedAmount;

  public static final String JSON_PROPERTY_AVAILABLE_STAKED_AMOUNT = "available_staked_amount";
  private TokenAmount availableStakedAmount;
  ...
  **/
  ...
  public NotEnoughTokensForUnstakeError pendingStakedAmount(TokenAmount pendingStakedAmount) {
    this.pendingStakedAmount = pendingStakedAmount;
    return this;
  }

   /**
   * Get pendingStakedAmount
   * @return pendingStakedAmount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_PENDING_STAKED_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public TokenAmount getPendingStakedAmount() {
    return pendingStakedAmount;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PENDING_STAKED_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPendingStakedAmount(TokenAmount pendingStakedAmount) {
    this.pendingStakedAmount = pendingStakedAmount;
  }


  public NotEnoughTokensForUnstakeError availableStakedAmount(TokenAmount availableStakedAmount) {
    this.availableStakedAmount = availableStakedAmount;
    return this;
  }

   /**
   * Get availableStakedAmount
   * @return availableStakedAmount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_AVAILABLE_STAKED_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public TokenAmount getAvailableStakedAmount() {
    return availableStakedAmount;
  }
  ...
  @JsonProperty(JSON_PROPERTY_AVAILABLE_STAKED_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAvailableStakedAmount(TokenAmount availableStakedAmount) {
    this.availableStakedAmount = availableStakedAmount;
  }


  /**
   * Return true if this NotEnoughTokensForUnstakeError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestedAmount, notEnoughTokensForUnstakeError.requestedAmount) &&
        Objects.equals(this.pendingStakedAmount, notEnoughTokensForUnstakeError.pendingStakedAmount) &&
        Objects.equals(this.availableStakedAmount, notEnoughTokensForUnstakeError.availableStakedAmount) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestedAmount, pendingStakedAmount, availableStakedAmount, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    pendingStakedAmount: ").append(toIndentedString(pendingStakedAmount)).append("\n");
    sb.append("    availableStakedAmount: ").append(toIndentedString(availableStakedAmount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
...
static {
  ...
  mappings.put("NotEnoughTokensForUnstakeError", NotEnoughTokensForUnstakeError.class);
  JSON.registerDiscriminator(NotEnoughTokensForUnstakeError.class, "type", mappings);
}
}
