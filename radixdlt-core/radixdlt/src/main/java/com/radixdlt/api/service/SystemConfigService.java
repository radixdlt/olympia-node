...
public class SystemConfigService {
	...
	static final List<CounterType> NETWORKING_COUNTERS = List.of(
		...
		CounterType.NETWORKING_P2P_SENT_BYTES,
		CounterType.NETWORKING_P2P_RECEIVED_BYTES,
		CounterType.NETWORKING_P2P_DROPPED_MESSAGES,
		CounterType.NETWORKING_P2P_ACTIVE_INBOUND_CHANNELS,
		CounterType.NETWORKING_P2P_ACTIVE_OUTBOUND_CHANNELS,
		CounterType.NETWORKING_P2P_ACTIVE_CHANNELS,
		CounterType.NETWORKING_P2P_CHANNELS_INITIALIZED,
		CounterType.NETWORKING_P2P_CHANNELS_CLOSED
	);
