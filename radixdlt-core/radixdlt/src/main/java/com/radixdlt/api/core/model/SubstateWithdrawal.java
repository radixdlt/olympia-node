...
public final class SubstateWithdrawal {
  ...
  public <X extends Exception> UInt256 execute(
      TxBuilder builder, UInt256 amount, Function<UInt256, X> exceptionSupplier) throws X {
    return builder.downFungible(index, predicate, amount, exceptionSupplier);
  }
}
