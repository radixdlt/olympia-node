...
final class NetworkMetricsHandler implements HttpHandler {
	private final NetworkInfoService networkInfoService;

	@Inject
	NetworkMetricsHandler(NetworkInfoService networkInfoService) {
	...
	private JSONObject handle() {
		return new JSONObject()
			.put("throughPut", networkInfoService.throughput())
			.put("demand", networkInfoService.demand());
	}
}
