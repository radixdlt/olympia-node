...
public final class BuildBelowMinStakeException extends CoreModelException {
	private final ResourceAmount minStake;
	private final ResourceAmount attempt;

	public BuildBelowMinStakeException(ResourceAmount minStake, ResourceAmount attempt) {
