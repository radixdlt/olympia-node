...
public interface TransactionAction {
	...
	static TransactionAction register(
		ECPublicKey validatorKey, Optional<String> name, Optional<String> url, Optional<HashCode> forkVoteHash
	) {
	...
	static TransactionAction update(
		ECPublicKey validatorKey, Optional<String> name, Optional<String> url, Optional<HashCode> forkVoteHash
	) {
