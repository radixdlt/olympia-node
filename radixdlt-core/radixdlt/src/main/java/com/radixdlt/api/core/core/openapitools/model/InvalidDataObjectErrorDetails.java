...
/**
 * InvalidDataObjectErrorDetails
 */
@JsonPropertyOrder({
  InvalidDataObjectErrorDetails.JSON_PROPERTY_INVALID_DATA_OBJECT,
  InvalidDataObjectErrorDetails.JSON_PROPERTY_MESSAGE
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-28T21:50:04.376464-06:00[America/Chicago]")
...
public class InvalidDataObjectErrorDetails extends ErrorDetails {
  public static final String JSON_PROPERTY_INVALID_DATA_OBJECT = "invalid_data_object";
  private DataObject invalidDataObject;

  public static final String JSON_PROPERTY_MESSAGE = "message";
  private String message;


  public InvalidDataObjectErrorDetails invalidDataObject(DataObject invalidDataObject) {
    this.invalidDataObject = invalidDataObject;
    return this;
  }

   /**
   * Get invalidDataObject
   * @return invalidDataObject
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_INVALID_DATA_OBJECT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public DataObject getInvalidDataObject() {
    return invalidDataObject;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INVALID_DATA_OBJECT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvalidDataObject(DataObject invalidDataObject) {
    this.invalidDataObject = invalidDataObject;
  }


  public InvalidDataObjectErrorDetails message(String message) {
  ...
  **/
  ...
  /**
   * Return true if this InvalidDataObjectErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InvalidDataObjectErrorDetails invalidDataObjectErrorDetails = (InvalidDataObjectErrorDetails) o;
    return Objects.equals(this.invalidDataObject, invalidDataObjectErrorDetails.invalidDataObject) &&
        Objects.equals(this.message, invalidDataObjectErrorDetails.message) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidDataObject, message, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvalidDataObjectErrorDetails {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    invalidDataObject: ").append(toIndentedString(invalidDataObject)).append("\n");
...
static {
  ...
  mappings.put("InvalidDataObjectErrorDetails", InvalidDataObjectErrorDetails.class);
  JSON.registerDiscriminator(InvalidDataObjectErrorDetails.class, "type", mappings);
}
}
