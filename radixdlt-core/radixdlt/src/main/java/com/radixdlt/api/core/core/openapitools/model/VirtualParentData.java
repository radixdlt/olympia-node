 ...
 */
@JsonPropertyOrder({
  VirtualParentData.JSON_PROPERTY_CHILD_TYPE
})
...
public class VirtualParentData extends DataObject {
  public static final String JSON_PROPERTY_CHILD_TYPE = "child_type";
  private String childType;


  public VirtualParentData childType(String childType) {
    this.childType = childType;
    return this;
  }

   /**
   * The type of the children under this parent
   * @return childType
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of the children under this parent")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.childType, virtualParentData.childType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(childType, super.hashCode());
  }
