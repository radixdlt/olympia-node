...
/**
 * BelowMinimumStakeErrorDetails
 */
@JsonPropertyOrder({
  BelowMinimumStakeErrorDetails.JSON_PROPERTY_MINIMUM_STAKE,
  BelowMinimumStakeErrorDetails.JSON_PROPERTY_ATTEMPTED_TO_STAKE
})
...
public class BelowMinimumStakeErrorDetails extends ErrorDetails {
  public static final String JSON_PROPERTY_MINIMUM_STAKE = "minimum_stake";
  private ResourceAmount minimumStake;

  public static final String JSON_PROPERTY_ATTEMPTED_TO_STAKE = "attempted_to_stake";
  private ResourceAmount attemptedToStake;


  public BelowMinimumStakeErrorDetails minimumStake(ResourceAmount minimumStake) {
  ...
  **/
  ...
  public BelowMinimumStakeErrorDetails attemptedToStake(ResourceAmount attemptedToStake) {
    this.attemptedToStake = attemptedToStake;
    return this;
  }

   /**
   * Get attemptedToStake
   * @return attemptedToStake
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_ATTEMPTED_TO_STAKE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public ResourceAmount getAttemptedToStake() {
    return attemptedToStake;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ATTEMPTED_TO_STAKE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttemptedToStake(ResourceAmount attemptedToStake) {
    this.attemptedToStake = attemptedToStake;
  }


  /**
   * Return true if this BelowMinimumStakeErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BelowMinimumStakeErrorDetails belowMinimumStakeErrorDetails = (BelowMinimumStakeErrorDetails) o;
    return Objects.equals(this.minimumStake, belowMinimumStakeErrorDetails.minimumStake) &&
        Objects.equals(this.attemptedToStake, belowMinimumStakeErrorDetails.attemptedToStake) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(minimumStake, attemptedToStake, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BelowMinimumStakeErrorDetails {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    minimumStake: ").append(toIndentedString(minimumStake)).append("\n");
    sb.append("    attemptedToStake: ").append(toIndentedString(attemptedToStake)).append("\n");
    sb.append("}");
    return sb.toString();
  }
...
static {
  ...
  mappings.put("BelowMinimumStakeErrorDetails", BelowMinimumStakeErrorDetails.class);
  JSON.registerDiscriminator(BelowMinimumStakeErrorDetails.class, "type", mappings);
}
}
