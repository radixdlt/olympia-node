...
public final class InvalidPartialStateIdentifierException extends CoreModelException {
	private final PartialStateIdentifier partialStateIdentifier;

	public InvalidPartialStateIdentifierException(PartialStateIdentifier partialStateIdentifier) {
		super(CoreModelError.BAD_REQUEST);
		this.partialStateIdentifier = partialStateIdentifier;
	}

	@Override
	public ErrorDetails getErrorDetails() {
		return new InvalidPartialStateIdentifierErrorDetails()
