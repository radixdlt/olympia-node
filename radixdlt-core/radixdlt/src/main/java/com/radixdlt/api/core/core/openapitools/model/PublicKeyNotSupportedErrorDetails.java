...
/**
 * PublicKeyNotSupportedErrorDetails
 */
@JsonPropertyOrder({
  PublicKeyNotSupportedErrorDetails.JSON_PROPERTY_UNSUPPORTED_PUBLIC_KEY
})
...
public class PublicKeyNotSupportedErrorDetails extends ErrorDetails {
  public static final String JSON_PROPERTY_UNSUPPORTED_PUBLIC_KEY = "unsupported_public_key";
  private PublicKey unsupportedPublicKey;


  public PublicKeyNotSupportedErrorDetails unsupportedPublicKey(PublicKey unsupportedPublicKey) {
    this.unsupportedPublicKey = unsupportedPublicKey;
    return this;
  }

   /**
   * Get unsupportedPublicKey
   * @return unsupportedPublicKey
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_UNSUPPORTED_PUBLIC_KEY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public PublicKey getUnsupportedPublicKey() {
    return unsupportedPublicKey;
  }
  ...
  @JsonProperty(JSON_PROPERTY_UNSUPPORTED_PUBLIC_KEY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setUnsupportedPublicKey(PublicKey unsupportedPublicKey) {
    this.unsupportedPublicKey = unsupportedPublicKey;
  }


  /**
   * Return true if this PublicKeyNotSupportedErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicKeyNotSupportedErrorDetails publicKeyNotSupportedErrorDetails = (PublicKeyNotSupportedErrorDetails) o;
    return Objects.equals(this.unsupportedPublicKey, publicKeyNotSupportedErrorDetails.unsupportedPublicKey) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(unsupportedPublicKey, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicKeyNotSupportedErrorDetails {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    unsupportedPublicKey: ").append(toIndentedString(unsupportedPublicKey)).append("\n");
    sb.append("}");
    return sb.toString();
  }
...
static {
  ...
  mappings.put("PublicKeyNotSupportedErrorDetails", PublicKeyNotSupportedErrorDetails.class);
  JSON.registerDiscriminator(PublicKeyNotSupportedErrorDetails.class, "type", mappings);
}
}
