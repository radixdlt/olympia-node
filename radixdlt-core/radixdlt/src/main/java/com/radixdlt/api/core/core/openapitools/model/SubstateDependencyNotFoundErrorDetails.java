...
/**
 * SubstateDependencyNotFoundErrorDetails
 */
@JsonPropertyOrder({
  SubstateDependencyNotFoundErrorDetails.JSON_PROPERTY_SUBSTATE_IDENTIFIER_NOT_FOUND
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-11-28T22:34:11.326400-06:00[America/Chicago]")
...
public class SubstateDependencyNotFoundErrorDetails extends ErrorDetails {
  ...
  public SubstateDependencyNotFoundErrorDetails substateIdentifierNotFound(SubstateIdentifier substateIdentifierNotFound) {
  ...
  **/
  ...
  /**
   * Return true if this SubstateDependencyNotFoundErrorDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SubstateDependencyNotFoundErrorDetails substateDependencyNotFoundErrorDetails = (SubstateDependencyNotFoundErrorDetails) o;
    return Objects.equals(this.substateIdentifierNotFound, substateDependencyNotFoundErrorDetails.substateIdentifierNotFound) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubstateDependencyNotFoundErrorDetails {\n");
...
static {
  ...
  mappings.put("SubstateDependencyNotFoundErrorDetails", SubstateDependencyNotFoundErrorDetails.class);
  JSON.registerDiscriminator(SubstateDependencyNotFoundErrorDetails.class, "type", mappings);
}
}
