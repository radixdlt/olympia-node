...
public final class InvalidPublicKeyException extends CoreModelException {
	private final PublicKey invalidPublicKey;

	public InvalidPublicKeyException(PublicKey invalidPublicKey) {
	...
	public ErrorDetails getErrorDetails() {
		return new InvalidPublicKeyErrorDetails()
