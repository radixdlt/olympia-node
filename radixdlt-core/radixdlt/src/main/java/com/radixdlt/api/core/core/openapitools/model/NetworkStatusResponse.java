...
public class NetworkStatusResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(preGenesisStateIdentifier, genesisStateIdentifier, currentStateIdentifier, currentStateEpoch, currentStateRound, currentStateTimestamp, nodeIdentifiers);
  }
