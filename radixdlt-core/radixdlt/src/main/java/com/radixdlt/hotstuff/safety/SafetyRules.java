...
public final class SafetyRules {
  ...
  private final ForkJoinPool signatureVerificationPool = ForkJoinPool.commonPool();
  ...
  public boolean verifyHighQcAgainstTheValidatorSet(HighQC highQC) {
    final var highestQcRes =
        signatureVerificationPool.submit(() -> verifyQcAgainstTheValidatorSet(highQC.highestQC()));

    final var committedQcRes =
        signatureVerificationPool.submit(
    ...
    return highestQcRes.join() && committedQcRes.join() && tcRes.join();
  }
