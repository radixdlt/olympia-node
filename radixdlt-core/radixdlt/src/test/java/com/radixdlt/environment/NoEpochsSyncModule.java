...
public class NoEpochsSyncModule extends AbstractModule {
  ...
  @ProvidesIntoSet
  private EventProcessorOnRunner<?> ledgerUpdateEventProcessor(LocalSyncService localSyncService) {
    return new EventProcessorOnRunner<>(
        Runners.SYNC, LedgerUpdate.class, localSyncService.ledgerUpdateEventProcessor());
  }
  ...
  private EventProcessorOnRunner<?> localSyncRequestEventProcessor(
    ...
    return new EventProcessorOnRunner<>(
        Runners.SYNC, LocalSyncRequest.class, localSyncService.localSyncRequestEventProcessor());
  }
  ...
  private EventProcessorOnRunner<?> syncCheckTriggerEventProcessor(
      LocalSyncService localSyncService) {
    return new EventProcessorOnRunner<>(
        Runners.SYNC, SyncCheckTrigger.class, localSyncService.syncCheckTriggerEventProcessor());
  }
