...
public class GetVerticesErrorResponseTest {
	...
	private GetVerticesRequest failingRequest;
	...
	public void setUp() {
		...
		this.failingRequest = mock(GetVerticesRequest.class);
		this.response = new GetVerticesErrorResponse(this.node, this.highQC, this.failingRequest);
	}
	...
	public void testGetters() {
		...
		assertThat(this.response.failingRequest()).isEqualTo(this.failingRequest);
	}
