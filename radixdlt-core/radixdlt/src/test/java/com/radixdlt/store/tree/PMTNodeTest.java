...
public class PMTNodeTest {
  ...
  @Test
  public void
      when_extension_node_with_non_empty_value_is_deserialized__then_it_is_created_correctly() {
    // given
  ...
  @Test
  public void
      when_branch_node_with_non_empty_value_is_deserialized__then_it_is_created_correctly() {
    // given
    PMTLeaf pmtLeaf = new PMTLeaf(KEY_NIBBLES, NON_EMPTY_VALUE);
    PMTBranch pmtBranch =
        new PMTBranch(
            NON_EMPTY_VALUE,
            new PMTBranch.PMTBranchChild(
                BRANCH_NIBBLE, PMT.represent(pmtLeaf, KECCAK_256, RLP_SERIALIZER)));
