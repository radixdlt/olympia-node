...
public class GetNextCommittedLedgerEntriesTest {
	...
	public void teardown() {
		if (this.injector != null) {
			...
			this.injector.getInstance(BerkeleySafetyStateStore.class).close();
	...
	public void database_smaller_than_limit__returns_smaller_than_limit() throws NextCommittedLimitReachedException {
		final var ledgerEntryStore = this.injector.getInstance(BerkeleyLedgerEntryStore.class);
	...
	private void generateLedgerEntries(BerkeleyLedgerEntryStore ledgerEntryStore, int numCommits, int commitSize) {
