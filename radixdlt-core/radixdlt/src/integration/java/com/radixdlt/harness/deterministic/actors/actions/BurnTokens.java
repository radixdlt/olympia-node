...
package com.radixdlt.harness.deterministic.actors.actions;
...
public final class BurnTokens implements NodeTransactionAction {
  private final Amount amount;
  private final TokenResourceIdentifier tokenResourceIdentifier;
  private final EntityIdentifier from;

  public BurnTokens(
      Amount amount, TokenResourceIdentifier tokenResourceIdentifier, EntityIdentifier from) {
    this.amount = amount;
