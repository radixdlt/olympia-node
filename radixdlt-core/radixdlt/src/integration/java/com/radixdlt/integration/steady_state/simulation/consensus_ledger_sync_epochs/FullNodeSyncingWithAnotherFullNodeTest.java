        ...
        SimulationTest.builder()
            ...
            .addressBook(
                ImmutableMap.of(
                    ...
                    NODE_UNDER_TEST,
                    ImmutableList.of(NON_VALIDATOR_SYNC_NODE)))
  ...
  public void given_a_full_node_that_is_only_conencted_to_another_full_node__it_should_sync() {
    ...
    final var testNodeCounters =
        runningTest
            .getNetwork()
            .getSystemCounters()
            .get(runningTest.getNetwork().getNodes().get(NODE_UNDER_TEST));
    ...
    final var syncNodeCounters =
        runningTest
            .getNetwork()
            .getSystemCounters()
            .get(runningTest.getNetwork().getNodes().get(NON_VALIDATOR_SYNC_NODE));
