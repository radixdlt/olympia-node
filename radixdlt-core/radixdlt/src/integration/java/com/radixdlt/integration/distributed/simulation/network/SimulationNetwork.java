...
public class SimulationNetwork {
	...
	public class SimulatedNetworkImpl implements
		...
		@Override
		public void sendGetVerticesErrorResponse(BFTNode node, HighQC syncInfo, GetVerticesRequest failingRequest) {
			final var vertexResponse = new GetVerticesErrorResponse(thisNode, syncInfo, failingRequest);
			receivedMessages.onNext(MessageInTransit.newMessage(vertexResponse, thisNode, node));
		}
