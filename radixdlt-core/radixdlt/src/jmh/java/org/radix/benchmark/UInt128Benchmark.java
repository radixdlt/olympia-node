 ...
 * gradle daemons. This can be worked around by avoiding the gradle daemon:
 *
 * <pre>
...
public class UInt128Benchmark {
  ...
  private static final BigInteger BI_LARGE_VALUE1 =
      BI_TWO.pow(UInt128.SIZE - 27).subtract(BigInteger.ONE);
  private static final BigInteger BI_LARGE_VALUE2 =
      BI_TWO.pow(UInt128.SIZE - 28).subtract(BigInteger.ONE);
