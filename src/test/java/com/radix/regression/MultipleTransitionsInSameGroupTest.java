...
public class MultipleTransitionsInSameGroupTest {
	...
	public void when_submitting_an_atom_with_one_down_of_same_consumable_within_a_group__then_atom_is_accepted() {
		...
		VariableTokenDefinitionParticle tokenDefinition = createTokenDefinition(myAddress);
	...
	private TransferrableTokensParticle createTransferrableTokens(RadixAddress myAddress, VariableTokenDefinitionParticle tokenDefinition, UInt256 amount) {
	...
	private UnallocatedTokensParticle createUnallocatedTokens(VariableTokenDefinitionParticle tokenDefinition) {
	...
	private VariableTokenDefinitionParticle createTokenDefinition(RadixAddress myAddress) {
		return new VariableTokenDefinitionParticle(
			myAddress,
			"Cookie Token",
			"FLO",
			"Cookies!",
