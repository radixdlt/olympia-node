...
public final class WireIO {
	...
	public static class Writer {
		...
		public void writeBoolean(boolean bool) throws IOException {
			outputStream.writeByte(bool ? 1 : 0);
		}
		...
		public void writeEUID(EUID euid) throws IOException {
			writeVarBytes(euid.toByteArray());
		}

		public void writeAID(AID aid) throws IOException {
