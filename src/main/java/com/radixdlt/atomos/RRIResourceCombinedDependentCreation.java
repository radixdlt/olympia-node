...
public class RRIResourceCombinedDependentCreation<T extends Particle, U extends Particle> implements TransitionProcedure {
	...
	public Pair<Class<? extends Particle>, Class<? extends Particle>> supports() {
		return Pair.of(RRIParticle.class, particleClass1);
	}
