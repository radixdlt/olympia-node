...
public class UpdateValidatorFeeTest {
  ...
  public void setup() throws Exception {
    ...
    cmAtomOS.load(
        new EpochUpdateConstraintScryptV3(new EpochUpdateConfig(1, 100, 1, 1, UInt256.TEN)));
            ...
            REConstructor.newBuilder()
                ...
                .put(
                    ...
                    new UpdateRakeConstructor(
                        2, ValidatorUpdateRakeConstraintScrypt.MAX_RAKE_INCREASE))
                .build(),
            cm,
            store);
  ...
  public void update_rake() throws Exception {
    ...
    var registerTxn =
        this.engine
            .construct(new UpdateValidatorFee(key.getPublicKey(), 100))
