...
public class FixedFeeTest {
	...
	public void paying_for_fees_should_work() throws Exception {
		...
		var accounting0 = REResourceAccounting.compute(result.getFirst().get(0).getGroupedStateUpdates().get(0));
		...
		var accounting1 = REResourceAccounting.compute(result.getFirst().get(0).getGroupedStateUpdates().get(1));
	...
	public void put_then_take_reserve_should_work() throws Exception {
		...
		var accounting2 = REResourceAccounting.compute(result.getFirst().get(0).getGroupedStateUpdates().get(2));
