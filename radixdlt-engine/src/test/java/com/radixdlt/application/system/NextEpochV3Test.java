...
import com.radixdlt.application.system.construction.epoch.v4.NextEpochConstructorV4;
...
public class NextEpochV3Test {
        ...
        new Object[][] {
          {
            List.of(
                ...
                new EpochUpdateConstraintScryptV4(
  ...
  public NextEpochV3Test(List<ConstraintScrypt> scrypts, REConstructor constructors) {
