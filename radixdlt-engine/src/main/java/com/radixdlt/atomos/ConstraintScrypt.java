...
public interface ConstraintScrypt {
  ...
  /**
   * Entrypoint to the constraint scrypt's logic. With the given AtomOS interface the smart
   * constraint adds custom application constraints on top of the ledger
   *
