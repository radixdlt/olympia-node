...
public record LoadingStake(ECPublicKey key, Function<ValidatorScratchPad, ReducerState> onDone)
    implements ReducerState {

  public ReducerState startUpdate(ValidatorStakeData stake) throws ProcedureException {
