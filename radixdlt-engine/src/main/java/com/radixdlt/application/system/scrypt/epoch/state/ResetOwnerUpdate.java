...
public record ResetOwnerUpdate(ECPublicKey validatorKey, Supplier<ReducerState> next)
    implements ReducerState {

  public ReducerState reset(ValidatorOwnerCopy update) throws ProcedureException {
