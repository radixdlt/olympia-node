...
public class SystemCallTokenHoldingBucketProcedure extends SystemCallProcedure<TokenHoldingBucket> {
  public SystemCallTokenHoldingBucketProcedure() {
    super(
        ...
        (tokenHoldingBucket, callData, context) -> {
          ...
          var amt = callData.getUInt256(1);
          var tokens = tokenHoldingBucket.withdraw(REAddr.ofNativeToken(), amt);
          context.depositFeeReserve(tokens);
