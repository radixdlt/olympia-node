...
public record ResetRakeUpdate(ValidatorFeeCopy update, Supplier<ReducerState> next)
    implements ReducerState {

  public ReducerState reset(ValidatorFeeCopy rakeCopy) throws ProcedureException {
