...
public record EpochConstructionStateV3(
    TxBuilder txBuilder,
  ...
  public static EpochConstructionStateV3 createState(
      NextEpochConfig constructor, TxBuilder txBuilder) {
    return new EpochConstructionStateV3(
        txBuilder,
  ...
  public void processExittingStake() {
    ...
    txBuilder
        .shutdownAll(index, EpochConstructionStateV3::collectExittingStake)
  ...
  public void processEmission() {
    txBuilder
        .shutdownAll(ValidatorBFTData.class, EpochConstructionStateV3::collectToMap)
