...
public class UpAllocatingVirtualStateProcedure
    extends UpProcedure<VirtualParent, AllocatingVirtualState> {
  public UpAllocatingVirtualStateProcedure() {
    super(
        VirtualParent.class,
        AllocatingVirtualState.class,
        virtualParent -> new Authorization(PermissionLevel.SYSTEM, (resources, context) -> {}),
        (virtualState, virtualParent, context) -> {
