...
import com.radixdlt.application.system.scrypt.epoch.states.Staking;
...
public class UpStakingProcedure extends UpProcedure<Staking, StakeOwnership> {
  public UpStakingProcedure() {
    super(
        Staking.class,
