...
import com.radixdlt.application.validators.scrypt.state.UpdatingRakeReady;
...
public class UpValidatorFeeCopyProcedure extends UpProcedure<ValidatorFeeCopy, UpdatingRakeReady> {
  public UpValidatorFeeCopyProcedure() {
    super(
