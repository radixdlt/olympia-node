...
public record UpdatingRegistered(ECPublicKey validatorKey, EpochData epochData)
    implements ReducerState {

  public void update(ValidatorRegisteredCopy update) throws ProcedureException {
