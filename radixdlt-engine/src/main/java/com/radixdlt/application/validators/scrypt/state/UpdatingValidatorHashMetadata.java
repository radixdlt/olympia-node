...
public record UpdatingValidatorHashMetadata(ValidatorSystemMetadata prevState)
    implements ReducerState {
  public void update(ValidatorSystemMetadata next) throws ProcedureException {
