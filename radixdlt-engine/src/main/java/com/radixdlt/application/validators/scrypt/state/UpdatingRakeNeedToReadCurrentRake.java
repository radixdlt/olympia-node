...
public record UpdatingRakeNeedToReadCurrentRake(
    long rakeIncreaseDebounceEpochLength, ECPublicKey validatorKey) implements ReducerState {
  public ReducerState readValidatorStakeState(ValidatorStakeData validatorStakeData)
    ...
    return new UpdatingRakeNeedToReadEpoch(rakeIncreaseDebounceEpochLength, validatorStakeData);
  }
}
