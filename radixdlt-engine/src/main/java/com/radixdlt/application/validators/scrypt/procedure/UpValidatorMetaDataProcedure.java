...
public class UpValidatorMetaDataProcedure
    extends UpProcedure<ValidatorMetaData, UpdatingValidatorInfo> {
  public UpValidatorMetaDataProcedure() {
    super(
          ...
          if (!Objects.equals(validatorInfo.prevState().validatorKey(), metaData.validatorKey())) {
            throw new ProcedureException(
                String.format(
                    ...
                    validatorInfo.prevState().validatorKey(), metaData.validatorKey()));
          }
