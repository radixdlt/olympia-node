...
import com.radixdlt.application.validators.scrypt.state.UpdatingRegistered;
...
public class UpValidatorRegisteredCopyProcedure
    extends UpProcedure<ValidatorRegisteredCopy, UpdatingRegistered> {
  public UpValidatorRegisteredCopyProcedure() {
    super(
