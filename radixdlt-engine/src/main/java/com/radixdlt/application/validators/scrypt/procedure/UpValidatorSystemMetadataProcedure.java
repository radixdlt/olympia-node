...
public class UpValidatorSystemMetadataProcedure
    extends UpProcedure<ValidatorSystemMetadata, UpdatingValidatorHashMetadata> {
  public UpValidatorSystemMetadataProcedure() {
    super(
