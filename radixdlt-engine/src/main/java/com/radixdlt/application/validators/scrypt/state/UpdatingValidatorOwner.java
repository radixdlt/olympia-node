...
public record UpdatingValidatorOwner(ECPublicKey validatorKey, EpochData epochData)
    implements ReducerState {

  public void update(ValidatorOwnerCopy update) throws ProcedureException {
