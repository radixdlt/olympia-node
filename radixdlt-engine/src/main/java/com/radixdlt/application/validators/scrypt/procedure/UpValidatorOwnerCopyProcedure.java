...
import com.radixdlt.application.validators.scrypt.state.UpdatingValidatorOwner;
...
public class UpValidatorOwnerCopyProcedure
    extends UpProcedure<ValidatorOwnerCopy, UpdatingValidatorOwner> {
  public UpValidatorOwnerCopyProcedure() {
    super(
