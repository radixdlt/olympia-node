...
public final class OwnerStakePrepare implements ReducerState {
  ...
  public ReducerState readOwner(ValidatorOwnerCopy ownerCopy) throws ProcedureException {
    ...
    return new StakePrepare(
        minimumStake, tokenHoldingBucket, allowDelegationFlag.validatorKey(), owner::equals);
  }
}
