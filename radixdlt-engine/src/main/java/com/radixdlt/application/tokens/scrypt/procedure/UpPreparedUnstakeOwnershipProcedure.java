...
public class UpPreparedUnstakeOwnershipProcedure
    extends UpProcedure<PreparedUnstakeOwnership, StakeOwnershipHoldingBucket> {
  public UpPreparedUnstakeOwnershipProcedure() {
    super(
